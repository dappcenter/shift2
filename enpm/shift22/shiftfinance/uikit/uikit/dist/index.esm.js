...
import React__default, { isValidElement, cloneElement, Children, forwardRef, useRef, useEffect, useState, useMemo, useReducer, useCallback, createContext, useContext } from 'react';
...
var StyledButton$1 = styled.button(templateObject_1$_ || (templateObject_1$_ = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 26px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n    box-shadow: none;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n    box-shadow: none;\n  }\n\n  ", "\n  ",
    "\n  ",
...
var Button = function (props) {
    ...
    return (React__default.createElement(StyledButton$1, __assign({ "$isLoading": isLoading, className: classNames.join(" "), disabled: isDisabled }, internalProps, rest),
...
var Icon$Z = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 35 33" }, props),
        React__default.createElement("path", { d: "m32.9582 1-13.1341 9.7183 2.4424-5.72731z", fill: "#e17726", stroke: "#e17726" }),
        React__default.createElement("g", { fill: "#e27625", stroke: "#e27625" },
            React__default.createElement("path", { d: "m2.66296 1 13.01714 9.809-2.3254-5.81802z" }),
            React__default.createElement("path", { d: "m28.2295 23.5335-3.4947 5.3386 7.4829 2.0603 2.1436-7.2823z" }),
            React__default.createElement("path", { d: "m1.27281 23.6501 2.13055 7.2823 7.46994-2.0603-3.48166-5.3386z" }),
            React__default.createElement("path", { d: "m10.4706 14.5149-2.0786 3.1358 7.405.3369-.2469-7.969z" }),
            React__default.createElement("path", { d: "m25.1505 14.5149-5.1575-4.58704-.1688 8.05974 7.4049-.3369z" }),
            React__default.createElement("path", { d: "m10.8733 28.8721 4.4819-2.1639-3.8583-3.0062z" }),
            React__default.createElement("path", { d: "m20.2659 26.7082 4.4689 2.1639-.6105-5.1701z" })),
        React__default.createElement("path", { d: "m24.7348 28.8721-4.469-2.1639.3638 2.9025-.039 1.231z", fill: "#d5bfb2", stroke: "#d5bfb2" }),
        React__default.createElement("path", { d: "m10.8732 28.8721 4.1572 1.9696-.026-1.231.3508-2.9025z", fill: "#d5bfb2", stroke: "#d5bfb2" }),
        React__default.createElement("path", { d: "m15.1084 21.7842-3.7155-1.0884 2.6243-1.2051z", fill: "#233447", stroke: "#233447" }),
        React__default.createElement("path", { d: "m20.5126 21.7842 1.0913-2.2935 2.6372 1.2051z", fill: "#233447", stroke: "#233447" }),
        React__default.createElement("path", { d: "m10.8733 28.8721.6495-5.3386-4.13117.1167z", fill: "#cc6228", stroke: "#cc6228" }),
        React__default.createElement("path", { d: "m24.0982 23.5335.6366 5.3386 3.4946-5.2219z", fill: "#cc6228", stroke: "#cc6228" }),
        React__default.createElement("path", { d: "m27.2291 17.6507-7.405.3369.6885 3.7966 1.0913-2.2935 2.6372 1.2051z", fill: "#cc6228", stroke: "#cc6228" }),
        React__default.createElement("path", { d: "m11.3929 20.6958 2.6242-1.2051 1.0913 2.2935.6885-3.7966-7.40495-.3369z", fill: "#cc6228", stroke: "#cc6228" }),
        React__default.createElement("path", { d: "m8.392 17.6507 3.1049 6.0513-.1039-3.0062z", fill: "#e27525", stroke: "#e27525" }),
        React__default.createElement("path", { d: "m24.2412 20.6958-.1169 3.0062 3.1049-6.0513z", fill: "#e27525", stroke: "#e27525" }),
        React__default.createElement("path", { d: "m15.797 17.9876-.6886 3.7967.8704 4.4833.1949-5.9087z", fill: "#e27525", stroke: "#e27525" }),
        React__default.createElement("path", { d: "m19.8242 17.9876-.3638 2.3584.1819 5.9216.8704-4.4833z", fill: "#e27525", stroke: "#e27525" }),
        React__default.createElement("path", { d: "m20.5127 21.7842-.8704 4.4834.6236.4406 3.8584-3.0062.1169-3.0062z", fill: "#f5841f", stroke: "#f5841f" }),
        React__default.createElement("path", { d: "m11.3929 20.6958.104 3.0062 3.8583 3.0062.6236-.4406-.8704-4.4834z", fill: "#f5841f", stroke: "#f5841f" }),
        React__default.createElement("path", { d: "m20.5906 30.8417.039-1.231-.3378-.2851h-4.9626l-.3248.2851.026 1.231-4.1572-1.9696 1.4551 1.1921 2.9489 2.0344h5.0536l2.962-2.0344 1.442-1.1921z", fill: "#c0ac9d", stroke: "#c0ac9d" }),
        React__default.createElement("path", { d: "m20.2659 26.7082-.6236-.4406h-3.6635l-.6236.4406-.3508 2.9025.3248-.2851h4.9626l.3378.2851z", fill: "#161616", stroke: "#161616" }),
        React__default.createElement("path", { d: "m33.5168 11.3532 1.1043-5.36447-1.6629-4.98873-12.6923 9.3944 4.8846 4.1205 6.8983 2.0085 1.52-1.7752-.6626-.4795 1.0523-.9588-.8054-.622 1.0523-.8034z", fill: "#763e1a", stroke: "#763e1a" }),
        React__default.createElement("path", { d: "m1 5.98873 1.11724 5.36447-.71451.5313 1.06527.8034-.80545.622 1.05228.9588-.66255.4795 1.51997 1.7752 6.89835-2.0085 4.8846-4.1205-12.69233-9.3944z", fill: "#763e1a", stroke: "#763e1a" }),
        React__default.createElement("path", { d: "m32.0489 16.5234-6.8983-2.0085 2.0786 3.1358-3.1049 6.0513 4.1052-.0519h6.1318z", fill: "#f5841f", stroke: "#f5841f" }),
        React__default.createElement("path", { d: "m10.4705 14.5149-6.89828 2.0085-2.29944 7.1267h6.11883l4.10519.0519-3.10487-6.0513z", fill: "#f5841f", stroke: "#f5841f" }),
        React__default.createElement("path", { d: "m19.8241 17.9876.4417-7.5932 2.0007-5.4034h-8.9119l2.0006 5.4034.4417 7.5932.1689 2.3842.013 5.8958h3.6635l.013-5.8958z", fill: "#f5841f", stroke: "#f5841f" })));
};
...
var ExpandableButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { "aria-label": "Hide or show expandable content", onClick: onClick },
        children,
        expanded ? React__default.createElement(Icon$1f, { color: "invertedContrast" }) : React__default.createElement(Icon$1i, { color: "invertedContrast" })));
};
...
var ExpandableLabel = function (_a) {
    var onClick = _a.onClick, expanded = _a.expanded, children = _a.children;
    return (React__default.createElement(Button, { variant: "text", "aria-label": "Hide or show expandable content", onClick: onClick, endIcon: expanded ? React__default.createElement(Icon$1f, { color: "primary" }) : React__default.createElement(Icon$1i, { color: "primary" }) }, children));
};
    ...
    return (React__default.createElement(StyledAlert, null,
        ...
        onClick && (React__default.createElement(CloseHandler, null,
            React__default.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default.createElement(Icon$1e, { width: "24px", color: "currentColor" }))))));
};
var templateObject_1$W, templateObject_2$n, templateObject_3$9, templateObject_4$7;
...
var BalanceInput = function (_a) {
    ...
    return (React__default.createElement(StyledBalanceInput, __assign({ isWarning: isWarning }, props),
        React__default.createElement(StyledInput$1, __assign({ pattern: "^[0-9]*[.,]?[0-9]{0," + decimals + "}$", inputMode: "decimal", min: "0", value: value, onChange: handleOnChange, placeholder: placeholder }, inputProps)),
...
var DefaultSeparator = React__default.createElement(Icon$1g, { color: "currentColor", width: "24px" });
...
var StyledButtonMenu = styled.div(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 16px;\n  display: inline-flex;\n  border: 1px solid ", ";\n\n  & > button + button,\n  & > a + a {\n    margin-left: 2px; // To avoid focus shadow overlap\n  }\n  ", "\n"], ["\n  background-color: ", ";\n  border-radius: 16px;\n  display: inline-flex;\n  border: 1px solid ", ";\n\n  & > button + button,\n  & > a + a {\n    margin-left: 2px; // To avoid focus shadow overlap\n  }\n  ", "\n"])), getBackgroundColor, getBorderColor, space);
var ButtonMenu$1 = function (_a) {
    ...
    return (React__default.createElement(StyledButtonMenu, __assign({ variant: variant }, props), Children.map(children, function (child, index) {
...
var InactiveButton = styled(Button)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return React__default.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary" }, props));
    }
...
var StyledCard = styled.div(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: ", ";\n  border: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"], ["\n  background-color: ", ";\n  border-radius: ", ";\n  border: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.card.borderRadius;
}, function (_a) {
    var theme = _a.theme;
    return theme.card.boxShadow;
...
var DropdownContent$1 = styled.div(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 400px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"], ["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 400px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"])), getLeft, getBottom, function (_a) {
    var theme = _a.theme;
...
var Dropdown$1 = function (_a) {
    ...
    return (React__default.createElement(Container$4, null,
        target,
        React__default.createElement(DropdownContent$1, { position: position }, children)));
};
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) {
        return (React__default.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
            React__default.createElement(Icon$14, { width: size, height: size })));
    });
...
var BackgroundImage = function (_a) {
    ...
    return React__default.createElement(StyledBackgroundImage, __assign({ ref: ref, width: width, height: height }, props));
};
...
var StyledTokenImage = styled(Image)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"], ["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"])));
var TokenImage = function (_a) {
    var tokenAddress = _a.tokenAddress, _b = _a.baseUrl, baseUrl = _b === void 0 ? "/images/tokens" : _b, _c = _a.imageFormat, imageFormat = _c === void 0 ? "svg" : _c, props = __rest(_a, ["tokenAddress", "baseUrl", "imageFormat"]);
    return React__default.createElement(StyledTokenImage, __assign({ src: baseUrl + "/" + tokenAddress + "." + imageFormat }, props));
};
...
var TokenPairImage = function (_a) {
    var secondaryTokenAddress = _a.secondaryTokenAddress, primaryTokenAddress = _a.primaryTokenAddress, width = _a.width, height = _a.height, _b = _a.variant, variant = _b === void 0 ? variants$3.DEFAULT : _b, _c = _a.primaryImageProps, primaryImageProps = _c === void 0 ? {} : _c, _d = _a.secondaryImageProps, secondaryImageProps = _d === void 0 ? {} : _d, props = __rest(_a, ["secondaryTokenAddress", "primaryTokenAddress", "width", "height", "variant", "primaryImageProps", "secondaryImageProps"]);
    ...
    return (React__default.createElement(Wrapper$3, __assign({ position: "relative", width: width, height: height }, props),
        React__default.createElement(StyledPrimaryImage, __assign({ variant: variant, tokenAddress: primaryTokenAddress, width: width, height: height }, primaryImageProps)),
        React__default.createElement(StyledSecondaryImage, __assign({ variant: variant, tokenAddress: secondaryTokenAddress, width: secondaryImageSize, height: secondaryImageSize }, secondaryImageProps))));
};
...
var LinkExternal = function (_a) {
    ...
    return (React__default.createElement(Link, __assign({ external: true }, props),
        children,
        React__default.createElement(Icon$W, { color: "primary", ml: "4px" })));
};
...
var Message = function (_a) {
    ...
    return (React__default.createElement(MessageContainer, __assign({ variant: variant }, props),
        React__default.createElement(Icon, { color: variants$2[variant].borderColor, width: "24px", mr: "12px", style: { alignSelf: "center" } }),
        children));
};
var templateObject_1$y;
...
var templateObject_1$w, templateObject_2$f, templateObject_3$8;
...
var bunnyHeadMain = "data:image/svg+xml,%3C%3Fxml%20version%3D%221.0%22%20encoding%3D%22utf-8%22%3F%3E%3Csvg%20version%3D%221.1%22%20id%3D%22Laag_1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20%20viewBox%3D%220%200%20330%20340%22%20style%3D%22enable-background%3Anew%200%200%20330%20340%3B%22%20xml%3Aspace%3D%22preserve%22%3E%3Cstyle%20type%3D%22text%2Fcss%22%3E%20.st0%7Bfill%3A%23AFD5F5%3B%7D%20.st1%7Bfill%3A%23C2EDFC%3B%7D%20.st2%7Bfill%3A%23A7B2F9%3B%7D%20.st3%7Bfill%3A%23C6D2F9%3B%7D%20.st4%7Bfill%3A%23A8B2F5%3B%7D%20.st5%7Bfill%3A%239F97F7%3B%7D%20.st6%7Bfill%3A%23BB98EF%3B%7D%20.st7%7Bfill%3A%23A296D1%3B%7D%20.st8%7Bfill%3A%23D99CEE%3B%7D%20.st9%7Bfill%3A%23F5D3FA%3B%7D%20.st10%7Bfill%3A%23D99CFA%3B%7D%20.st11%7Bfill%3A%23D2FDFE%3B%7D%20.st12%7Bfill%3A%23FFFFFF%3B%7D%3C%2Fstyle%3E%3Cg%3E%20%3Cpolygon%20class%3D%22st0%22%20points%3D%2280.9%2C187.1%2027.7%2C175.2%205.3%2C241.8%2044.5%2C197.4%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st0%22%20points%3D%2268.7%2C221.6%2080.9%2C187.1%2044.5%2C197.4%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st1%22%20points%3D%2268.7%2C221.6%2044.5%2C197.4%205.3%2C241.8%2094%2C288.7%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st0%22%20points%3D%2268.7%2C221.6%2068.7%2C221.6%2094%2C288.7%20182.7%2C335.6%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st0%22%20points%3D%22182.7%2C335.6%20310.3%2C208.2%20245.5%2C217.1%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st0%22%20points%3D%22283.7%2C136.7%20223.6%2C170.9%20274.2%2C162.8%20324.7%2C193.7%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st1%22%20points%3D%22274.2%2C162.8%20245.5%2C217.1%20310.3%2C208.2%20324.7%2C193.7%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st2%22%20points%3D%22126.8%2C165.9%20126.8%2C165.9%20149.8%2C235.7%20171.8%2C239.5%20145.2%2C6.2%20108.3%2C109.9%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22st3%22%20points%3D%22173%2C239.7%20217%2C226%20145.2%2C6.2%20171.8%2C239.5%20%20%22%2F%3E%20%3Cpolygon%20class%3D%22
1-1.9%2C1.8l-12.8-2.2c-0.5-2.2-2.3-3.8-4.6-4l-20.1-61c1.1-0.9%2C1.8-2.3%2C1.8-3.8%20%20c0-2.7-2.1-4.8-4.7-5l-16.8-51l34-95.6L169.4%2C235.1z%20M42.8%2C202.1c0.5%2C0.2%2C1.1%2C0.3%2C1.7%2C0.3c0.7%2C0%2C1.4-0.1%2C2-0.4l17.6%2C17.6%20%20c-0.3%2C0.6-0.4%2C1.3-0.4%2C2c0%2C2.7%2C2.2%2C5%2C4.9%2C5l22%2C58.3L8.2%2C241.3L42.8%2C202.1z%20M245%2C222c0.2%2C0%2C0.3%2C0%2C0.5%2C0c2.3%2C0%2C4.3-1.6%2C4.8-3.8%20%20l54.7-7.5L190%2C325.6L245%2C222z%20M309.4%2C206.4l-59.6%2C8.2c-0.2-0.3-0.4-0.6-0.6-0.8l24.3-46c0.2%2C0%2C0.3%2C0.1%2C0.5%2C0.1c1.1%2C0%2C2.2-0.4%2C3-1%20%20l44.6%2C27.2L309.4%2C206.4z%20M283.1%2C139.1l34.7%2C48.3L279%2C163.7c0-0.3%2C0.1-0.6%2C0.1-0.8c0-2.8-2.2-5-5-5c-2.4%2C0-4.4%2C1.7-4.9%2C3.9%20%20l-35.9%2C5.7L283.1%2C139.1z%20M29%2C177.4l44.4%2C9.9l-24.9%2C7.1c-0.9-1.2-2.3-2-4-2c-2.8%2C0-5%2C2.2-5%2C5c0%2C0.8%2C0.2%2C1.6%2C0.6%2C2.2L10%2C233.7%20%20L29%2C177.4z%22%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E";
...
var BunnySlider = styled.div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"], ["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"])));
var StyledInput = styled.input(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"], ["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"])), getCursorStyle, getBaseThumbStyles, getBaseThumbStyles, getBaseThumbStyles);
var BarBackground = styled.div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  background-color: ", ";\n  height: 2px;\n  position: absolute;\n  top: 18px;\n  width: 100%;\n"], ["\n  background-color: ", ";\n  height: 2px;\n  position: absolute;\n  top: 18px;\n  width: 100%;\n"])), function (_a) {
    var theme = _a.theme, disabled = _a.disabled;
    return theme.colors[disabled ? "textDisabled" : "inputSecondary"];
});
var BarProgress = styled.div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"], ["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"])), function (_a) {
    var theme = _a.theme;
...
var templateObject_1$s, templateObject_2$d, templateObject_3$7, templateObject_4$6, templateObject_5$3, templateObject_6$1;
...
var templateObject_1$r, templateObject_2$c, templateObject_3$6, templateObject_4$5, templateObject_5$2;

var Container$3 = styled.div(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var Spinner = function (_a) {
    var src = _a.src;
    return (React__default.createElement(Container$3, null,
        React__default.createElement("img", { src: src, alt: "logo", width: "200px", style: { paddingRight: "5px" } })));
};
var templateObject_1$q;
...
var templateObject_1$o, templateObject_2$b, templateObject_3$5, templateObject_4$4, templateObject_5$1, templateObject_6, templateObject_7;
...
var Tab = styled.button(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"])), getPadding, getBorderRadius, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, color);
Tab.defaultProps = {
...
function BrandLogo(props) {
    return (React.createElement("svg", __assign({ id: "prefix__Layer_2", "data-name": "Layer 2", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 319.843 62.999" }, props),
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "prefix__linear-gradient", x1: 21.432, y1: 24.815, x2: 21.432, y2: 37.339, gradientUnits: "userSpaceOnUse" },
                React.createElement("stop", { offset: 0, stopColor: "#fff" }),
                React.createElement("stop", { offset: 0.298, stopColor: "#fffdff" }),
                React.createElement("stop", { offset: 0.443, stopColor: "#fdf5fe" }),
                React.createElement("stop", { offset: 0.555, stopColor: "#fae8fc" }),
                React.createElement("stop", { offset: 0.65, stopColor: "#f6d6fa" }),
                React.createElement("stop", { offset: 0.665, stopColor: "#f5d2fa" }),
                React.createElement("stop", { offset: 0.74, stopColor: "#f1d2fa" }),
                React.createElement("stop", { offset: 0.822, stopColor: "#e3d2f9" }),
                React.createElement("stop", { offset: 0.907, stopColor: "#ced3f7" }),
                React.createElement("stop", { offset: 0.994, stopColor: "#afd4f5" }),
                React.createElement("stop", { offset: 1, stopColor: "#add4f5" })),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-2", x1: 40.337, y1: 24.815, x2: 40.337, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-3", x1: 45.371, y1: 21.178, x2: 45.371, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-4", x1: 58.3, y1: 21.178, x2: 58.3, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-5", x1: 90.611, y1: 24.815, x2: 90.611, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-6", x1: 109.021, y1: 24.815, x2: 109.021, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-7", x1: 114.141, y1: 21.178, x2: 114.141, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-8", x1: 146.946, y1: 24.815, x2: 146.946, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-9", x1: 151.448, y1: 21.178, x2: 151.448, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-10", x1: 167.342, y1: 21.178, x2: 167.342, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-11", x1: 186.105, y1: 21.178, x2: 186.105, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-12", x1: 197.087, y1: 21.178, x2: 197.087, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-13", x1: 209.113, y1: 21.178, x2: 209.113, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-14", x1: 219.801, y1: 21.178, x2: 219.801, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-15", x1: 233.632, y1: 21.178, x2: 233.632, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-16", x1: 254.59, y1: 21.178, x2: 254.59, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-17", x1: 275.565, y1: 21.178, x2: 275.565, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-18", x1: 308.977, y1: 24.815, x2: 308.977, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("linearGradient", { id: "prefix__linear-gradient-19", x1: 312.796, y1: 21.178, x2: 312.796, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React.createElement("style", null, ".prefix__cls-2{fill:#b2d5f1}.prefix__cls-3{fill:#fff}.prefix__cls-4{fill:#c4e9f7}.prefix__cls-5{fill:#abb1d9}.prefix__cls-14{fill:#da9ded}")),
        React.createElement("g", { opacity: 0.2 },
            React.createElement("path", { className: "prefix__cls-2", d: "M143.553 34.556l-10.041-2.271-4.279 12.575 7.422-8.383 6.898-1.921z" }),
            React.createElement("path", { className: "prefix__cls-3", d: "
", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.347 66.635a.5.5 0 01-.496-.443l-7.073-61.998a.5.5 0 01.993-.114l7.074 61.998a.5.5 0 01-.44.554.599.599 0 01-.058.003z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M174.515 48.56a.434.434 0 01-.086-.008l-19.648-3.406a.5.5 0 11.171-.984l19.648 3.406a.5.5 0 01-.085.992z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M174.514 48.56a.5.5 0 01-.146-.979l13.71-4.191a.5.5 0 01.292.957l-13.71 4.191a.502.502 0 01-.146.022zM154.867 45.154a.5.5 0 01-.345-.863l11.002-10.478a.5.5 0 01.69.725L155.21 45.016a.5.5 0 01-.344.138z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.5.5 0 01-.475-.344l-13.972-42.525a.5.5 0 01.95-.313l13.971 42.526a.5.5 0 01-.318.63.484.484 0 01-.156.026z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.493.493 0 01-.15-.022.501.501 0 01-.328-.627l6.413-20.454L168.8 4.292a.5.5 0 11.95-.31l13.536 41.39a.507.507 0 01.002.305l-6.461 20.606a.501.501 0 01-.477.351z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.5.5 0 01-.353-.854L202.5 39.362l-7.258-10.03-10.874 6.238a.5.5 0 11-.498-.867l11.265-6.462a.5.5 0 01.654.14l7.772 10.74a.5.5 0 01-.053.648L176.7 66.489a.497.497 0 01-.352.145z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M203.155 39.914a.499.499 0 01-.258-.072l-9.364-5.668-9.337 1.456a.5.5 0 01-.154-.988l9.518-1.485a.504.504 0 01.335.067l9.52 5.762a.5.5 0 01-.26.928z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.5.5 0 01-.442-.735l17.29-32.483a.5.5 0 11.882.47L176.79 66.37a.499.499 0 01-.441.265z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M188.223 44.368a.5.5 0 01-.07-.995l12.225-1.747a.51.51 0 01.565.425.5.5 0 01-.424.565l-12.225 1.748a.587.587 0 01-.071.005zM176.349 66.634a.5.5 0 01-.234-.057l-33.445-17.64a.5.5 0 01-.24-.603l4.28-12.573a.5.5 0 01.584-.327l10.04 2.27a.5.5 0 11-.22.976l-9.602-2.171-3.997 11.743 33.067 17.44a.5.5 0 01-.233.942z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M142.904 48.995a.5.5 0 01-.375-.83l7.423-8.383a.496.496 0 01.24-.15l6.898-1.92a.5.5 0 11.268.962l-6.756 1.882-7.324 8.27a.497.497 0 01-.374.17z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.498.498 0 01-.354-.146l-26.021-26.022a.5.5 0 01.707-.707L176.7 65.782a.5.5 0 01-.353.853z", transform: "translate(-13.671 -3.636)" }),
            React.createElement("path", { className: "prefix__cls-3", d: "M159.67 57.816a.5.5 0 01-.468-.323L154.4 44.831a.5.5 0 11.935-.355l4.803 12.662a.5.5 0 01-.29.645.511.511 0 01-.178.033z", transform: "translate(-13.671 -3.636)" })),
        React.createElement("path", { className: "prefix__cls-3", d: "M23.115 51.602v-6.948h-2.568v-.78h6.12v.78h-2.568v6.948zM28.047 51.602v-8.088h.984v3.012a3.326 3.326 0 01.93-.528 3.453 3.453 0 011.242-.204 1.816 1.816 0 012.064 2.088v3.72h-.984v-3.684a1.346 1.346 0 00-.33-1.038 1.617 1.617 0 00-1.085-.294 2.58 2.58
6.17 6.17 0 011.122-.336v.768a7.865 7.865 0 00-.733.198 7.925 7.925 0 00-.755.282 3.426 3.426 0 00-.6.324v4.236zM324.06 51.722a3.159 3.159 0 01-2.28-.732 3.007 3.007 0 01-.757-2.256 3.271 3.271 0 01.654-2.154 2.544 2.544 0 012.07-.785 2.81 2.81 0 011.386.305 1.973 1.973 0 01.817.84 2.64 2.64 0 01.27 1.206v1.069h-4.213a2.223 2.223 0 00.282 1.02 1.298 1.298 0 00.708.534 3.958 3.958 0 001.254.162 4.192 4.192 0 001.608-.3v.768a3.952 3.952 0 01-.834.24 5.416 5.416 0 01-.965.083zm-2.052-3.216h3.336v-.469a1.478 1.478 0 00-.366-1.073 1.625 1.625 0 00-1.206-.378 1.68 1.68 0 00-1.392.48 2.33 2.33 0 00-.372 1.44zM24.899 23.61H13.67v13.374h3.097V32.14h8.13c3.116 0 4.294-1.312 4.294-3.23v-2.07c0-1.919-1.178-3.23-4.293-3.23zm1.197 5.32c0 .494-.286.779-.894.779h-8.434v-3.686h8.415a.82.82 0 01.912.874zM44.867 23.61h-9.061c-3.116 0-4.293 1.312-4.293 3.23v6.915c0 1.919 1.177 3.23 4.293 3.23h9.062c3.115 0 4.293-1.311 4.293-3.23v-6.916c0-1.918-1.178-3.229-4.294-3.229zm1.197 10.164c0 .55-.418.778-1.197.778h-9.061c-.78 0-1.197-.227-1.197-.778v-6.973c0-.531.418-.778 1.196-.778h9.063c.778 0 1.196.247 1.196.778z", transform: "translate(-13.671 -3.636)" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M41.647 19.973h-3.134v13.375h13.716v-2.432H41.647V19.973zM58.329 25.806l-6.136-5.833h-3.952l8.549 8.075v5.3h3.097v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M82.946 26.84v6.914c0 1.92 1.177 3.23 4.293 3.23h11.038v-2.432H87.239c-.779 0-1.197-.228-1.197-.778V26.8c0-.531.418-.778 1.197-.778h11.038V23.61H87.239c-3.116 0-4.293 1.311-4.293 3.23zM112.678 23.61h-11.626v13.374h3.097v-5.947h6.383l2.982 5.947h3.325L113.837 31c2.394-.323 3.153-1.597 3.153-3.192v-.97c0-1.917-1.196-3.228-4.312-3.228zm1.197 4.218c0 .645-.38.798-1.197.798h-8.53v-2.603h8.53c.78 0 1.197.247 1.197.778z", transform: "translate(-13.671 -3.636)" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M114.169 25.806l-6.136-5.833h-3.951l8.549 8.075v5.3h3.096v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M150.945 28.606h-7.998c-.874 0-1.235-.246-1.235-.817v-.95c0-.607.418-.816 1.235-.816h11.569V23.61h-11.57c-3.134 0-4.33 1.312-4.33 3.25v.91c0 1.938 1.196 3.249 4.33 3.249h7.999c.854 0 1.215.209 1.215.816v1.92c0 .646-.341.797-1.215.797h-11.893v2.432h11.893c3.134 0 4.33-1.33 4.33-3.268v-1.861c0-1.938-1.196-3.25-4.33-3.25z", transform: "translate(-13.671 -3.636)" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M159.826 19.973H143.07v2.414h6.897v10.961h3.115V22.387h6.744v-2.414zM166.23 19.973l-8.91 13.375h3.457l6.612-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28zM182.381 19.973h-3.134v13.375h13.715v-2.432h-10.581V19.973zM195.263 30.878h3.647v2.47h-3.647zM202.065 33.348h3.097v-5.3h10.22v-2.413h-10.22v-3.248h10.999v-2.414h-14.096v13.375zM218.252 19.974h3.097v13.374h-3.097zM239.987 29.131l-12.747-9.158h-2.679v13.375h2.697v-9.746l13.926 9.746h1.52V19.973h-2.717v9.158zM253.478 19.973l-8.909 13.375h3.457l6.611-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28zM281.919 29.131l-12.747-9.158h-2.678v13.375h2.697v-9.746l13.926 9.746h1.519V19.973h-2.717v9.158z" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M301.312 26.84v6.914c0 1.92 1.178 3.23 4.293 3.23h11.037v-2.432h-11.037c-.778 0-1.196-.228-1.196-.778V26.8c0-.531.418-.778 1.196-.778h11.037V23.61h-11.037c-3.115 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)" }),
        React.createElement("path", { className: "prefix__cls-3", d: "M305.748 33.348h14.095v-2.432h-10.999v-3.419h10.41v-2.432h-10.41v-2.678h10.999v-2.414h-14.095v13.375z" }),
        React.createElement("path", { d: "M24.899 23.61H13.67v13.374h3.097V32.14h8.13c3.116 0 4.294-1.312 4.294-3.23v-2.07c0-1.919-1.178-3.23-4.293-3.23zm1.197 5.32c0 .494-.286.779-.893.779h-8.435v-3.686h8.415a.82.82 0 01.913.874z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient)" }),
        React.createElement("path", { d: "M44.867 23.61h-9.061c-3.116 0-4.293 1.312-4.293 3.23v6.915c0 1.919 1.177 3.23 4.293 3.23h9.062c3.115 0 4.293-1.311 4.293-3.23v-6.916c0-1.918-1.178-3.229-4.294-3.229zm1.197 10.164c0 .55-.418.778-1.196.778h-9.063c-.778 0-1.196-.227-1.196-.778v-6.973c0-.531.418-.778 1.197-.778h9.062c.778 0 1.196.247 1.196.778z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-2)" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-3)", d: "M41.648 19.973h-3.135v13.375h13.716v-2.432H41.648V19.973z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-4)", d: "M58.329 25.806l-6.136-5.833h-3.952l8.549 8.075v5.3h3.097v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React.createElement("path", { d: "M82.946 26.84v6.914c0 1.92 1.177 3.23 4.293 3.23h11.038v-2.432H87.239c-.779 0-1.197-.228-1.197-.778V26.8c0-.531.418-.778 1.197-.778h11.038V23.61H87.239c-3.116 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-5)" }),
        React.createElement("path", { d: "M112.678 23.61h-11.626v13.374h3.097v-5.947h6.383l2.982 5.947h3.325L113.837 31c2.394-.323 3.154-1.597 3.154-3.192v-.97c0-1.917-1.197-3.228-4.313-3.228zm1.197 4.218c0 .645-.38.798-1.197.798h-8.53v-2.603h8.53c.78 0 1.197.247 1.197.778z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-6)" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-7)", d: "M114.169 25.806l-6.136-5.833h-3.951l8.549 8.075v5.3h3.096v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React.createElement("path", { d: "M150.945 28.606h-7.998c-.874 0-1.235-.246-1.235-.817v-.95c0-.607.418-.816 1.235-.816h11.569V23.61h-11.57c-3.134 0-4.33 1.312-4.33 3.25v.91c0 1.938 1.196 3.249 4.33 3.249h7.999c.854 0 1.215.209 1.215.816v1.92c0 .646-.341.797-1.215.797h-11.893v2.432h11.893c3.134 0 4.33-1.33 4.33-3.268v-1.861c0-1.938-1.195-3.25-4.33-3.25z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-8)" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-9)", d: "M159.826 19.973H143.07v2.414h6.897v10.961h3.115V22.387h6.744v-2.414z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-10)", d: "M166.23 19.973l-8.91 13.375h3.457l6.612-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-11)", d: "M182.381 19.973h-3.134v13.375h13.715v-2.432h-10.581V19.973z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-12)", d: "M195.263 30.878h3.647v2.47h-3.647z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-13)", d: "M202.065 33.348h3.097v-5.3h10.22v-2.413h-10.22v-3.248h10.999v-2.414h-14.096v13.375z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-14)", d: "M218.252 19.974h3.097v13.374h-3.097z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-15)", d: "M239.987 29.131l-12.747-9.158h-2.679v13.375h2.697v-9.746l13.926 9.746h1.52V19.973h-2.717v9.158z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-16)", d: "M253.478 19.973l-8.909 13.375h3.457l6.611-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28z" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-17)", d: "M281.92 29.131l-12.748-9.158h-2.678v13.375h2.697v-9.746l13.926 9.746h1.519V19.973h-2.716v9.158z" }),
        React.createElement("path", { d: "M301.312 26.84v6.914c0 1.92 1.178 3.23 4.293 3.23h11.037v-2.432h-11.037c-.778 0-1.196-.228-1.196-.778V26.8c0-.531.418-.778 1.196-.778h11.037V23.61h-11.037c-3.115 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-18)" }),
        React.createElement("path", { fill: "url(#prefix__linear-gradient-19)", d: "M305.748 33.348h14.095v-2.432h-10.999v-3.419h10.41v-2.432h-10.41v-2.678h10.999v-2.414h-14.095v13.375z" })));
}

// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
function IconLogo(props) {
    return (React.createElement("svg", __assign({ id: "prefix__Layer_1", "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 251.491 259.275" }, props),
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), {
    background: "#000000", backgroundDisabled: "#E9EAEB",
     ...
     gradients: {
        ...
        violet: "linear-gradient(180deg, #8080800%, #808080 100%)",
        violetAlt: "linear-gradient(180deg, #808080 0%,#808080 100%)",
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), {
    ...
    background: "#000000",
     ...
     contrast: "#FFFFFF",
      ...
      gradients: {
        background: "#000000",
        bubblegum: "linear-gradient(139.73deg, #808080 0%, #808080 100%)",
        inverseBubblegum: "linear-gradient(139.73deg, #3D2A54 0%, #313D5C 100%)",
        cardHeader: "linear-gradient(166.77deg, #3B4155 0%, #3A3045 100%)",
        blue: "linear-gradient(180deg, #00707F 0%, #19778C 100%)",
        violet: "linear-gradient(180deg, #808080 0%, ##808080 100%)",
        violetAlt: "linear-gradient(180deg,#808080 0%, #808080 100%)",
        gold: "linear-gradient(180deg, #FFD800 0%, #FDAB32 100%)",
    }
});
...
var ModalCloseButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React__default.createElement(Icon$1e, { color: "primary" })));
};
var ModalBackButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default.createElement(Icon$1z, { color: "primary" })));
};
...
var templateObject_1$i, templateObject_2$7, templateObject_3$3, templateObject_4$3;
...
var Icon$k = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 330 330" }, props),
        React__default.createElement("g", null,
            React__default.createElement("path", { d: "M165,0C74.019,0,0,74.02,0,165.001C0,255.982,74.019,330,165,330s165-74.018,165-164.999C330,74.02,255.981,0,165,0z\n\t\t M165,300c-74.44,0-135-60.56-135-134.999C30,90.562,90.56,30,165,30s135,60.562,135,135.001C300,239.44,239.439,300,165,300z" }),
            React__default.createElement("path", { d: "M164.998,70c-11.026,0-19.996,8.976-19.996,20.009c0,11.023,8.97,19.991,19.996,19.991\n\t\tc11.026,0,19.996-8.968,19.996-19.991C184.994,78.976,176.024,70,164.998,70z" }),
            React__default.createElement("path", { d: "M165,140c-8.284,0-15,6.716-15,15v90c0,8.284,6.716,15,15,15c8.284,0,15-6.716,15-15v-90C180,146.716,173.284,140,165,140z\n\t\t" }))));
};
...
var Logo$2 = React__default.memo(Logo$1, function (prev, next) { return prev.isDark === next.isDark; });
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// shell
var Icon$i = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 60 60" }, props),
        React.createElement("image", { width: "60", height: "60", href: '/images/Shell.svg' }),
        ")"));
};
...
var Icon$b = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default.createElement("path", { d: "M12 3C7.02985 3 3 7.02985 3 11.9904C3 16.9606 7.02985 21 12 21C16.9701 21 21 16.9606 21 11.9904C21 7.02985 16.9701 3 12 3ZM16.4328 8.65139C16.3753 9.48614 14.8305 15.7228 14.8305 15.7228C14.8305 15.7228 14.7345 16.0874 14.3987 16.097C14.2836 16.097 14.1301 16.0874 13.9574 15.9243C13.6023 15.6269 12.7964 15.0512 12.0384 14.5235C12.0096 14.5522 11.9808 14.581 11.9424 14.6098C11.7697 14.7633 11.5107 14.984 11.2324 15.2527C11.1269 15.3486 11.0117 15.4542 10.8966 15.5693L10.887 15.5789C10.8198 15.6461 10.7623 15.694 10.7143 15.7324C10.3401 16.0394 10.3017 15.7804 10.3017 15.6461L10.5032 13.4488V13.4296L10.5128 13.4104C10.5224 13.3817 10.5416 13.3721 10.5416 13.3721C10.5416 13.3721 14.4659 9.87953 14.5714 9.50533C14.581 9.48614 14.5522 9.46695 14.5043 9.48614C14.2452 9.57249 9.72601 12.4318 9.22708 12.7484C9.19829 12.7676 9.11194 12.758 9.11194 12.758L6.91471 12.0384C6.91471 12.0384 6.65565 11.9328 6.742 11.693C6.76119 11.645 6.78998 11.597 6.89552 11.5299C7.38486 11.1844 15.8955 8.12367 15.8955 8.12367C15.8955 8.12367 16.1354 8.04691 16.2793 8.09488C16.3465 8.12367 16.3849 8.15245 16.4232 8.2484C16.4328 8.28678 16.4424 8.36354 16.4424 8.44989C16.4424 8.49787 16.4328 8.55544 16.4328 8.65139Z" })));
};

var Icon$a = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M14.3137 3L15.2631 3.94934C14.5597 5.19866 14.7398 6.81097 15.8032 7.87441C16.8667 8.93786 18.479 9.11792 19.7283 8.4146L20.6777 9.36396L17.6569 12.3848L17.1287 11.8566C16.7382 11.4661 16.105 11.4661 15.7145 11.8566C15.3239 12.2471 15.3239 12.8803 15.7145 13.2708L16.2426 13.799L9.36396 20.6777L8.49923 19.8129C9.71921 18.5286 9.69924 16.4983 8.43932 15.2384C7.1794 13.9784 5.14908 13.9585 3.86473 15.1784L3 14.3137L9.87868 7.43503L10.2145 7.77081C10.605 8.16134 11.2382 8.16134 11.6287 7.77081C12.0192 7.38029 12.0192 6.74713 11.6287 6.3566L11.2929 6.02081L14.3137 3ZM12.8995 1.58579C13.6805 0.804738 14.9469 0.804738 15.7279 1.58579L17.299 3.15684C17.6895 3.54736 17.6895 4.18053 17.299 4.57105L17.2175 4.65257C16.7183 5.15173 16.7183 5.96103 17.2175 6.4602C17.7166 6.95936 18.5259 6.95936 19.0251 6.4602L19.1066 6.37868C19.4971 5.98816 20.1303 5.98816 20.5208 6.37868L22.0919 7.94975C22.8729 8.7308 22.8729 9.99713 22.0919 10.7782L10.7782 22.0919C9.99713 22.8729 8.7308 22.8729 7.94975 22.0919L6.37869 20.5208C5.98817 20.1303 5.98817 19.4971 6.37869 19.1066L7.02511 18.4602C7.52427 17.961 7.52427 17.1517 7.02511 16.6526C6.52594 16.1534 5.71664 16.1534 5.21748 16.6526L4.57106 17.299C4.18054 17.6895 3.54737 17.6895 3.15685 17.299L1.58579 15.7279C0.804738 14.9469 0.804738 13.6805 1.58579 12.8995L12.8995 1.58579ZM13.8787 8.6066C13.4882 8.21608 12.855 8.21608 12.4645 8.6066C12.0739 8.99712 12.0739 9.63029 12.4645 10.0208L13.4645 11.0208C13.855 11.4113 14.4882 11.4113 14.8787 11.0208C15.2692 10.6303 15.2692 9.99713 14.8787 9.6066L13.8787 8.6066Z" })));
};

var Icon$9 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 335 400" }, props),
        React__default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m152.5 104c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m264.5 72c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m376.5 168c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m40.5 0c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" })));
};

var Icon$8 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default.createElement("path", { d: "M8.65854 19C15.4488 19 19.1659 13.2338 19.1659 8.23717C19.1659 8.07728 19.1659 7.91739 19.1561 7.7475C19.878 7.21785 20.5024 6.5483 21 5.78881C20.3366 6.08861 19.6244 6.28847 18.8732 6.38841C19.6341 5.91872 20.2195 5.17921 20.5024 4.28981C19.7902 4.72951 19 5.03931 18.1512 5.20919C17.478 4.45969 16.522 4 15.4585 4C13.4195 4 11.761 5.69887 11.761 7.78747C11.761 8.08728 11.8 8.36709 11.8585 8.6469C8.79512 8.497 6.07317 6.97801 4.24878 4.68954C3.92683 5.25916 3.75122 5.90873 3.75122 6.59827C3.75122 7.90739 4.40488 9.06662 5.39024 9.74617C4.78537 9.72618 4.21951 9.5563 3.72195 9.27648C3.72195 9.28648 3.72195 9.30646 3.72195 9.32645C3.72195 11.1552 5 12.6942 6.67805 13.034C6.36585 13.1239 6.0439 13.1639 5.70244 13.1639C5.46829 13.1639 5.23415 13.1439 5.00976 13.0939C5.47805 14.6029 6.8439 15.6922 8.46341 15.7222C7.19512 16.7415 5.60488 17.3411 3.87805 17.3411C3.58537 17.3411 3.28293 17.3311 3 17.2911C4.62927 18.3704 6.57073 19 8.65854 19Z" })));
};

var Icon$7 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 117.2 122.88" }, props),
        React__default.createElement("path", { d: "M13.6 0h94.33a9.24 9.24 0 016.54 2.72l.01.01a9.24 9.24 0 012.72 6.54v95.79a9.24 9.24 0 01-2.72 6.54l-.01.01a9.24 9.24 0 01-6.54 2.72h-9.01l-3.72 8.54H84.78l-3.9-8.54H43.16l-3.72 8.54H29.02l-3.9-8.54H13.6a9.24 9.24 0 01-6.54-2.72l-.01-.01a9.24 9.24 0 01-2.72-6.54v-8.35H2.3c-1.26 0-2.3-1.03-2.3-2.3V64.93c0-1.26 1.03-2.3 2.3-2.3h2.03V49.32H2.3c-1.26 0-2.3-1.03-2.3-2.3V17.53c0-1.26 1.03-2.3 2.3-2.3h2.03V9.27a9.24 9.24 0 012.72-6.54l.01-.01A9.24 9.24 0 0113.6 0zm37.11 35.13a2.191 2.191 0 01-3.8 2.18l-2.87-4.97c-1.6 1.08-3.08 2.31-4.44 3.67a30.067 30.067 0 00-3.67 4.44l4.98 2.88c1.05.61 1.41 1.95.8 3s-1.95 1.41-3 .8l-4.98-2.87a30.278 30.278 0 00-2.96 11.07h5.74c1.21 0 2.2.99 2.2 2.2 0 1.21-.99 2.2-2.2 2.2h-5.74c.28 3.95 1.32 7.69 2.96 11.07l4.98-2.88a2.191 2.191 0 012.18 3.8l-4.97 2.87c1.08 1.6 2.31 3.08 3.67 4.44 1.36 1.36 2.84 2.59 4.44 3.67l2.88-4.98a2.193 2.193 0 013-.8c1.05.61 1.41 1.95.8 3l-2.87 4.98c3.39 1.64 7.12 2.68 11.07 2.96V82.1c0-1.21.99-2.2 2.2-2.2 1.21 0 2.2.99 2.2 2.2v5.74c3.95-.28 7.69-1.32 11.07-2.96L71.5 79.9a2.191 2.191 0 013.8-2.18l2.87 4.97c1.6-1.08 3.08-2.31 4.44-3.67 1.36-1.36 2.59-2.85 3.67-4.44l-4.97-2.87a2.191 2.191 0 012.18-3.8l4.98 2.88c1.65-3.39 2.68-7.13 2.96-11.07H85.7c-1.21 0-2.2-.99-2.2-2.2 0-1.21.99-2.2 2.2-2.2h5.74c-.28-3.95-1.32-7.69-2.96-11.07l-4.98 2.88a2.191 2.191 0 01-2.18-3.8l4.97-2.87c-1.08-1.6-2.31-3.08-3.67-4.44a30.593 30.593 0 00-4.44-3.67l-2.87 4.97a2.191 2.191 0 01-3.8-2.18l2.88-4.98a30.135 30.135 0 00-11.07-2.96v5.74c0 1.21-.99 2.2-2.2 2.2-1.21 0-2.2-.99-2.2-2.2V27.2c-3.95.28-7.69 1.32-11.07 2.96l2.86 4.97zM8.72 62.63h2.21c1.26 0 2.3 1.03 2.3 2.3v29.49c0 1.26-1.03 2.3-2.3 2.3H8.72v8.35c0 1.34.55 2.56 1.42 3.44l.01.01c.88.88 2.1 1.42 3.44 1.42h94.33c1.34 0 2.56-.55 3.44-1.42l.01-.01c.88-.88 1.42-2.1 1.42-3.44V9.27c0-1.34-.55-2.56-1.42-3.44l-.01-.01c-.88-.88-2.1-1.42-3.44-1.42H13.6c-1.34 0-2.56.55-3.44 1.42l-.01.01c-.88.88-1.42 2.1-1.42 3.44v5.96h2.21c1.26 0 2.3 1.03 2.3 2.3v29.49c0 1.26-1.03 2.3-2.3 2.3H8.72v13.31zm52.39-24.11c5.24 0 9.99 2.13 13.43 5.56s5.56 8.18 5.56 13.43c0 5.24-2.13 9.99-5.56 13.43a18.915 18.915 0 01-13.43 5.56c-5.24 0-9.99-2.13-13.43-5.56a18.915 18.915 0 01-5.56-13.43c0-5.24 2.13-9.99 5.56-13.43 3.43-3.43 8.18-5.56 13.43-5.56zm0-15.82c9.61 0 18.32 3.9 24.62 10.2 6.3 6.3 10.2 15 10.2 24.62s-3.9 18.32-10.2 24.62c-6.3 6.3-15 10.2-24.62 10.2-9.61 0-18.32-3.9-24.62-10.2-6.3-6.3-10.2-15-10.2-24.62 0-9.61 3.9-18.32 10.2-24.62 6.3-6.3 15-10.2 24.62-10.2z" })));
};
...
var ThemeSwitcher = function (_a) {
    ...
    return (React__default.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
        React__default.createElement(Flex, { alignItems: "center" },
            React__default.createElement(SunIcon, { color: isDark ? "textDisabled" : "text", width: "24px" }),
            React__default.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
            React__default.createElement(MoonIcon, { color: isDark ? "text" : "textDisabled", width: "24px" }))));
};
React__default.memo(ThemeSwitcher, function (prev, next) { return prev.isDark === next.isDark; });
...
var TokenPrice = function (_a) {
    var tokenPriceUsd = _a.tokenPriceUsd, showIcon = _a.showIcon, infoLink = _a.infoLink;
    return tokenPriceUsd ? (React__default.createElement(PriceLink, { href: infoLink, target: "_blank" },
        showIcon && React__default.createElement(IconLogo, { width: "30px", style: { paddingRight: "5px" } }),
        React__default.createElement(Text, { color: "contrast", bold: true }, "$" + tokenPriceUsd.toFixed(3)))) : (React__default.createElement(Skeleton, { width: 0, height: 0 }));
};
var TokenPrice$1 = React__default.memo(TokenPrice);
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/polycrystalfinance",
            },
        ],
    },
    {
...
var Logo = function (_a) {
    var isPushed = _a.isPushed, togglePush = _a.togglePush, href = _a.href, isDark = _a.isDark, isMobile = _a.isMobile, tokenPriceUsd = _a.tokenPriceUsd, infoLink = _a.infoLink;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = React__default.createElement(React__default.Fragment, null, isDark ? React__default.createElement(IconLogo, { className: "logo" }) : React__default.createElement(IconLogo, { className: "logo" }));
    var brand = React__default.createElement("h1", { className: "brand-name" }, "?");
    return (React__default.createElement(Flex, null,
        isMobile && (React__default.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default.createElement(Icon$n, { width: "24px", color: "primary" })) : (React__default.createElement(Icon$o, { width: "24px", color: "primary" })))),
        isAbsoluteUrl ? (React__default.createElement(StyledLink, { className: "brand", as: "a", href: href, "aria-label": "PolyCrystal Finance" },
            innerLogo,
            isMobile ? React__default.createElement(React__default.Fragment, null) : brand)) : (React__default.createElement(StyledLink, { className: "brand", to: href, "aria-label": "PolyCrystal Finance" },
                innerLogo,
                isMobile ? React__default.createElement(React__default.Fragment, null) : brand)),
        isMobile && React__default.createElement(TokenPrice$1, { tokenPriceUsd: tokenPriceUsd, showIcon: false, infoLink: infoLink })));
};
...
var LinkLabelMemo = React__default.memo(LinkLabel, function (prev, next) { return prev.isPushed === next.isPushed; });
...
var DropdownContent = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  color: ", ";\n  background-color: ", ";\n  border-color: ", ";\n  z-index: 1;\n  overflow: hidden;\n"], ["\n  display: none;\n  position: absolute;\n  color: ", ";\n  background-color: ", ";\n  border-color: ", ";\n  z-index: 1;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
...
var Dropdown = styled.div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n  &:hover ", " {\n    display: block;\n    transition: max-height 0.3s ease-out;\n  }\n"], ["\n  position: relative;\n  display: inline-block;\n  &:hover ", " {\n    display: block;\n    transition: max-height 0.3s ease-out;\n  }\n"])), DropdownContent);
var Accordion = function (_a) {
    var label = _a.label, status = _a.status, icon = _a.icon, isPushed = _a.isPushed, pushNav = _a.pushNav, _b = _a.initialOpenState, initialOpenState = _b === void 0 ? false : _b, children = _a.children, className = _a.className, isActive = _a.isActive, isMobile = _a.isMobile;
    ...
    return (React__default.createElement(Container$2, null, isMobile ? (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(MenuEntry, { onClick: handleClick, className: className, isActive: isActive, role: "button" },
            icon,
            React__default.createElement(LinkLabelMemo, { isPushed: isPushed }, label),
            status && (React__default.createElement(LinkStatus, { color: status.color, fontSize: "14px" }, status.text)),
            isOpen ? React__default.createElement(Icon$1w, null) : React__default.createElement(Icon$1x, null)),
        React__default.createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, maxHeight: React__default.Children.count(children) * MENU_ENTRY_HEIGHT }, children))) : (React__default.createElement(Dropdown, null,
            React__default.createElement(MenuEntry, { onMouseEnter: handleClick, onMouseLeave: handleClick, className: className, isActive: isActive, role: "button" },
                label !== "More" && icon,
                React__default.createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, label),
                status && (React__default.createElement(LinkStatus, { color: status.color, fontSize: "14px" }, status.text)),
                React__default.createElement(Icon$1x, null)),
            React__default.createElement(DropdownContent, null, children)))));
};
var templateObject_1$b, templateObject_2$4, templateObject_3$1, templateObject_4$1;
...
var MenuLink = function (_a) {
    ...
    return React__default.createElement(Tag, __assign({ role: "button" }, props, otherProps));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default.createElement(Container$1, null, links.map(function (entry) {
        ...
        var iconElement = React__default.createElement(Icon, { width: "24px", mr: "8px" });
        var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
        if (entry.items) {
            var itemsMatchIndex = entry.items.findIndex(function (item) { return item.href === location.pathname; });
            var initialOpenState = entry.initialOpenState === true ? entry.initialOpenState : itemsMatchIndex >= 0;
            return (React__default.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                entry.items.map(function (item) {
                    return (React__default.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                        React__default.createElement(MenuLink, { href: item.href },
                            React__default.createElement(LinkLabelMemo, { isPushed: isPushed }, item.label),
                            item.status && (React__default.createElement(LinkStatus, { color: item.status.color, fontSize: "14px" }, item.status.text)))));
                })));
        }
        return (React__default.createElement(MenuLink, { key: entry.label, href: entry.href, onClick: handleClick },
            React__default.createElement(MenuEntry, { isActive: entry.href === location.pathname, className: calloutClass },
                iconElement,
                React__default.createElement(LinkLabelMemo, { isPushed: isPushed }, entry.label),
                entry.status && (React__default.createElement(LinkStatus, { color: entry.status.color, fontSize: "14px" }, entry.status.text)))));
    })));
};
var templateObject_1$a;
...
var LangSelector = function (_a) {
    ...
    return (React__default.createElement(Dropdown$1, {
        position: "top-right", target: React__default.createElement(Button, { variant: "text", startIcon: React__default.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
            React__default.createElement(Text, { color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase()))
...
React__default.memo(LangSelector, function (prev, next) { return prev.currentLang === next.currentLang; });

var Icons = IconModule;
var SocialLinks = function () {
    return (React__default.createElement(Flex, null, socials.map(function (social, index) {
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var crystlPriceUsd = _a.crystlPriceUsd; _a.currentLang; _a.langs; _a.setLang; var infoLink = _a.infoLink;
    if (!isPushed) {
        return (React__default.createElement(Container, null,
            React__default.createElement(IconButton, { variant: "text", onClick: function () { return pushNav(true); } },
                React__default.createElement(Icon$1d, null))));
    }
    return (React__default.createElement(Container, null,
        React__default.createElement(SocialEntry, null,
            React__default.createElement(TokenPrice$1, { tokenPriceUsd: crystlPriceUsd, showIcon: true, infoLink: infoLink })),
        false,
        false,
        false));
};
...
var Panel = function (props) {
    ...
    return (React__default.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu },
        React__default.createElement(PanelBody, __assign({}, props)),
        React__default.createElement(PanelFooter, __assign({}, props))));
};
...
var Icon$2 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default.createElement("path", { d: "M96 48C96 21.4903 74.5097 0 48 0C21.4903 0 0 21.4903 0 48C0 74.5097 21.4903 96 48 96C74.5097 96 96 74.5097 96 48Z", fill: "#3389FB" }),
        React__default.createElement("path", { d: "M29.6927 35.4245C39.8036 25.5252 56.1965 25.5252 66.3074 35.4245L67.5242 36.6159C68.0298 37.1109 68.0298 37.9134 67.5242 38.4084L63.3616 42.4839C63.1088 42.7314 62.699 42.7314 62.4462 42.4839L60.7717 40.8444C53.7181 33.9384 42.282 33.9384 35.2284 40.8444L33.4351 42.6002C33.1823 42.8477 32.7725 42.8477 32.5197 42.6002L28.3571 38.5247C27.8515 38.0297 27.8515 37.2272 28.3571 36.7322L29.6927 35.4245ZM74.9161 43.8532L78.6208 47.4805C79.1264 47.9755 79.1264 48.778 78.6208 49.2729L61.9159 65.6288C61.4103 66.1237 60.5907 66.1237 60.0851 65.6288C60.0851 65.6288 60.0851 65.6288 60.0851 65.6288L48.229 54.0206C48.1026 53.8968 47.8977 53.8968 47.7713 54.0206C47.7713 54.0206 47.7713 54.0206 47.7713 54.0206L35.9153 65.6288C35.4098 66.1237 34.5902 66.1237 34.0846 65.6288C34.0846 65.6288 34.0846 65.6288 34.0846 65.6288L17.3792 49.2727C16.8736 48.7778 16.8736 47.9753 17.3792 47.4803L21.0839 43.853C21.5895 43.3581 22.4091 43.3581 22.9146 43.853L34.771 55.4614C34.8974 55.5851 35.1023 55.5851 35.2287 55.4614C35.2287 55.4614 35.2287 55.4614 35.2287 55.4614L47.0844 43.853C47.59 43.358 48.4096 43.358 48.9152 43.853C48.9152 43.853 48.9152 43.853 48.9152 43.853L60.7715 55.4614C60.8979 55.5851 61.1028 55.5851 61.2292 55.4614L73.0854 43.8532C73.5909 43.3583 74.4105 43.3583 74.9161 43.8532Z", fill: "white" })));
};

var Icon$1 = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default.createElement("path", { d: "M24 0H8C3.58172 0 0 3.58172 0 8V24C0 28.4183 3.58172 32 8 32H24C28.4183 32 32 28.4183 32 24V8C32 3.58172 28.4183 0 24 0Z", fill: "#1E2026" }),
        React__default.createElement("path", { d: "M16.2857 4L9.97035 7.6761L12.2922 9.03415L16.2857 6.7161L20.2792 9.03415L22.6011 7.6761L16.2857 4Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M20.2792 10.9541L22.6011 12.3122V15.0283L18.6075 17.3463V21.9824L16.2857 23.3405L13.9639 21.9824V17.3463L9.97035 15.0283V12.3122L12.2922 10.9541L16.2857 13.2722L20.2792 10.9541Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M22.6011 16.9483V19.6644L20.2792 21.0224V18.3063L22.6011 16.9483Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M20.2561 22.9424L24.2496 20.6244V15.9883L26.5714 14.6302V21.9824L20.2561 25.6585V22.9424Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M24.2496 11.3522L21.9278 9.99414L24.2496 8.63609L26.5714 9.99414V12.7102L24.2496 14.0683V11.3522Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M13.9639 26.642V23.9259L16.2857 25.2839L18.6075 23.9259V26.642L16.2857 28L13.9639 26.642Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M12.2922 21.0224L9.97035 19.6644V16.9483L12.2922 18.3063V21.0224Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M16.2857 11.3522L13.9639 9.99414L16.2857 8.63609L18.6075 9.99414L16.2857 11.3522Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M10.6437 9.99414L8.32183 11.3522V14.0683L6 12.7102V9.99414L8.32183 8.63609L10.6437 9.99414Z", fill: "#F0B90B" }),
        React__default.createElement("path", { d: "M6 14.6302L8.32183 15.9883V20.6244L12.3154 22.9424V25.6585L6 21.9824V14.6302Z", fill: "#F0B90B" })));
};

var Icon = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default.createElement("circle", { cx: "48", cy: "48", r: "48", fill: "#F5F5F5" }),
        React__default.createElement("path", { d: "M56.5504425,41.9387033 L56.5504425,50.4659601 L47.3948342,50.4659601 L47.3948342,85.5971142 L45.0078131,84.7075452 C43.8992633,84.2955753 42.1136272,83.5937969 39.9052997,82.5918134 L38.8675775,82.1177881 L38.8675775,14.6817622 L47.9569067,11.8769231 L56.5504425,14.5267861 L56.5504425,23.7259307 L47.9569067,21.0669705 L47.3948342,21.2411155 L47.3948342,41.9387033 L56.5504425,41.9387033 Z M16,50.4659926 L16,21.7739797 L36.1702794,15.548296 L36.1702794,24.7052039 L24.526282,28.3200122 L24.526282,41.9387358 L36.1702794,41.9387358 L36.1702794,81.3806284 L33.591244,80.0543973 C25.5662786,75.923652 16,68.9585019 16,59.2339983 L16,54.6496962 L24.526282,54.6496962 L24.526282,59.2339983 C24.526282,61.2460878 25.5734263,63.3605199 27.6426978,65.5373324 L27.6426978,50.4659926 L16,50.4659926 Z M59.1389325,15.3302574 L79.8040306,21.7261873 L79.8040306,50.4659601 L67.6710627,50.4659601 L67.6710627,62.9111544 C67.6710627,62.9111544 64.9581695,66.4674811 59.1464051,69.4451657 C59.1464051,67.0682164 59.1389325,15.3302574 59.1389325,15.3302574 Z M71.2780734,41.9387033 L71.2780734,28.2783928 L67.6710627,27.1649695 L67.6710627,41.9387033 L71.2780734,41.9387033 Z M71.2780734,59.8661186 L71.2780734,54.6495662 L79.8040306,54.6495662 L79.8040306,59.8661186 C79.8040306,74.3588162 58.7760221,82.7005566 52.330058,84.9127828 L49.9859233,85.7230769 L49.9859233,76.7068496 L51.1311866,76.2744112 C61.1591444,72.5004032 71.2780734,65.962818 71.2780734,59.8661186 Z", fill: "#000000" })));
};
...
var WalletCard = function (_a) {
    ...
    return (React__default.createElement(Button, {
        width: "100%", variant: "tertiary", onClick: function () {
            login(walletConfig.connectorId);
            window.localStorage.setItem(connectorLocalStorageKey, walletConfig.connectorId);
            onDismiss();
        }, style: { justifyContent: "space-between" }, mb: mb, id: "wallet-connect-" + title.toLocaleLowerCase()
    },
        React__default.createElement(Text, { bold: true, color: "primary", mr: "16px" }, title),
        React__default.createElement(Icon, { width: "32px" })));
};

var HelpLink = styled(Link)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React__default.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        connectors.map(function (entry, index) { return (React__default.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }),
        React__default.createElement(HelpLink, { href: "https://polycrystalfinance.medium.com/crystal-clear-educational-series-2-setting-up-a-metamask-wallet-a762f5668941", external: true },
            React__default.createElement(Icon$19, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default.createElement(StyleButton, __assign({
        ...
        children,
        React__default.createElement(Icon$1b, { width: "20px", color: "primary", ml: "4px" }),
...
var AccountModal = function (_a) {
    ...
    return (React__default.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default.createElement(Flex, { mb: "32px" },
            React__default.createElement(LinkExternal, { small: true, href: "https://polygonscan.com/address/" + account, mr: "16px" }, "View on BSCScan"),
...
var UserBlock = function (_a) {
    ...
    return (React__default.createElement("div", null, account ? (React__default.createElement(StyledButton, {
        scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        }
    }, accountEllipsis)) : (React__default.createElement(StyledButton, {
        scale: "sm", onClick: function () {
            onPresentConnectModal();
        }
    }, "Connect"))));
};
var UserBlock$1 = React__default.memo(UserBlock, function (prevProps, nextProps) {
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default.createElement(Icon$X, { width: "32px", height: "32px" }));
    if (isExternal) {
        return (React__default.createElement(StyledAvatar, { title: username },
            React__default.createElement("a", { href: link, "aria-label": ariaLabel }, icon),
            showPip && React__default.createElement(Pip, null)));
    }
    return (React__default.createElement(StyledAvatar, { title: username },
        React__default.createElement(Link$1, { to: link, "aria-label": ariaLabel }, icon),
        showPip && React__default.createElement(Pip, null)));
};
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, toggleTheme = _a.toggleTheme, isDark = _a.isDark, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, crystlPriceUsd = _a.crystlPriceUsd, links = _a.links, profile = _a.profile, children = _a.children, infoLink = _a.infoLink;
    var isXl = useMatchBreakpoints().isXl;
    var isMobile = isXl === false;
    var _c = useState(!isMobile ? false : !isMobile), isPushed = _c[0], setIsPushed = _c[1];
    ...
    return (React__default.createElement(Wrapper, null,
        React__default.createElement(StyledNav, { showMenu: showMenu },
            React__default.createElement(Logo, { isPushed: isMobile ? isPushed : false, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/", isMobile: isMobile, tokenPriceUsd: crystlPriceUsd, infoLink: infoLink }),
            !isMobile &&
            links.map(function (entry) {
                ...
                if (entry.items) {
                    var itemsMatchIndex = entry.items.findIndex(function (item) { return item.href === location.pathname; });
                    var initialOpenState = entry.initialOpenState === true ? entry.initialOpenState : itemsMatchIndex >= 0;
                    return (React__default.createElement(Accordion, { key: entry.label, isPushed: isMobile, pushNav: setIsPushed, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                        entry.items.map(function (item) {
                            return (React__default.createElement(MenuLink, { href: item.href },
                                React__default.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                                    React__default.createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, item.label))));
                        })));
                }
                return (React__default.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    React__default.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: entry.calloutClass ? entry.calloutClass : undefined },
                        iconElement,
                        React__default.createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, entry.label))));
            }),
            !isMobile && React__default.createElement(TokenPrice$1, { tokenPriceUsd: crystlPriceUsd, showIcon: true, infoLink: infoLink }),
            !!login && !!logout && (React__default.createElement(Flex, null,
                React__default.createElement(UserBlock$1, { account: account, login: login, logout: logout }),
                profile && React__default.createElement(Avatar, { profile: profile }))),
            false),
        React__default.createElement(BodyWrapper, null,
            isMobile && (React__default.createElement(Panel, { isPushed: isMobile ? isPushed : true, isMobile: isMobile, showMenu: isMobile ? showMenu : false, toggleTheme: toggleTheme, isDark: isDark, langs: langs, setLang: setLang, currentLang: currentLang, crystlPriceUsd: crystlPriceUsd, pushNav: setIsPushed, links: links, infoLink: infoLink })),
            React__default.createElement(Inner, { isPushed: isPushed, showMenu: showMenu, isMobile: isMobile }, children),
            React__default.createElement(MobileOnlyOverlay, { show: isPushed, onClick: function () { return setIsPushed(false); }, role: "presentation" }))));
};
