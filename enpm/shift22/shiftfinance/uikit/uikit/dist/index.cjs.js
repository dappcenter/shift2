...
var rotate = styled.keyframes(templateObject_1$11 || (templateObject_1$11 = __makeTemplateObject(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"], ["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var Text = styled__default['default'].div(templateObject_1$10 || (templateObject_1$10 = __makeTemplateObject(["\n  color: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  line-height: 1.5;\n  ", "\n  ", "\n\n  ", "\n  ", "\n  ", "\n"], ["\n  color: ", ";\n  font-size: ", ";\n  font-weight: ", ";\n  line-height: 1.5;\n  ", "\n  ",
...
var TooltipText = styled__default['default'](Text)(templateObject_1$$ || (templateObject_1$$ = __makeTemplateObject(["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"], ["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledButton$1 = styled__default['default'].button(templateObject_1$_ || (templateObject_1$_ = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n    box-shadow: none;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s, opacity 0.2s;\n\n  &:hover:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.pancake-button--disabled):not(.pancake-button--disabled) {\n    opacity: 0.85;\n    transform: translateY(1px);\n    box-shadow: none;\n  }\n\n  ", "\n  ",
    "\n  ",
...
var IconButton = styled__default['default'](Button)(templateObject_1$Z || (templateObject_1$Z = __makeTemplateObject(["\n  padding: 0;\n  width: ", ";\n"], ["\n  padding: 0;\n  width: ", ";\n"])), function (_a) {
    var scale = _a.scale;
...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        <image width="80" height="80" href={'/images/Shell.png'} />
    ))
};
...
var Box = styled__default['default'].div(templateObject_1$Y || (templateObject_1$Y = __makeTemplateObject(["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"])), styledSystem.background, styledSystem.border, styledSystem.layout, styledSystem.position, styledSystem.space);
var templateObject_1$Y;

var Flex = styled__default['default'](Box)(templateObject_1$X || (templateObject_1$X = __makeTemplateObject(["\n  display: flex;\n  ", "\n"], ["\n  display: flex;\n  ", "\n"])), styledSystem.flexbox);
...
var IconLabel = styled__default['default'].div(templateObject_1$W || (templateObject_1$W = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"], ["\n  background-color: ", ";\n  border-radius: 16px 0 0 16px;\n  color: ", ";\n  padding: 12px;\n"])), getThemeColor, function (_a) {
    var theme = _a.theme;
...
var StyledBalanceInput = styled__default['default'](Box)(templateObject_1$U || (templateObject_1$U = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var Grid = styled__default['default'](Box)(templateObject_1$T || (templateObject_1$T = __makeTemplateObject(["\n  display: grid;\n  ", "\n  ", "\n"], ["\n  display: grid;\n  ", "\n  ", "\n"])), styledSystem.flexbox, styledSystem.grid);
var templateObject_1$T;

var Separator = styled__default['default'].div(templateObject_1$S || (templateObject_1$S = __makeTemplateObject(["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  justify-content: center;\n  padding-left: 4px;\n  padding-right: 4px;\n\n  ", " {\n    padding-left: 8px;\n    padding-right: 8px;\n  }\n\n  ", " {\n    padding-left: 16px;\n    padding-right: 16px;\n  }\n"], ["\n  align-items: center;\n  color: ", ";\n  display: flex;\n  justify-content: center;\n  padding-left: 4px;\n  padding-right: 4px;\n\n  ", " {\n    padding-left: 8px;\n    padding-right: 8px;\n  }\n\n  ", " {\n    padding-left: 16px;\n    padding-right: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textDisabled;
}, function (_a) {
    var theme = _a.theme;
...
var StyledButtonMenu = styled__default['default'].div(templateObject_1$R || (templateObject_1$R = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 16px;\n  display: inline-flex;\n  border: 10px solid ", ";\n\n  & > button + button,\n  & > a + a {\n    margin-left: 2px; // To avoid focus shadow overlap\n  }\n  ", "\n"], ["\n  background-color: ", ";\n  border-radius: 16px;\n  display: inline-flex;\n  border: 1px solid ", ";\n\n  & > button + button,\n  & > a + a {\n    margin-left: 2px; // To avoid focus shadow overlap\n  }\n  ", "\n"])), getBackgroundColor, getBorderColor, styledSystem.space);
...
var InactiveButton = styled__default['default'](Button)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"], ["\n  background-color: transparent;\n  color: ", ";\n  &:hover:not(:disabled):not(:active) {\n    background-color: transparent;\n  }\n"])), function (_a) {
    var theme = _a.theme, variant = _a.variant;
...
var StyledCard = styled__default['default'].div(templateObject_1$P || (templateObject_1$P = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: ", ";\n  border: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"], ["\n  background-color: ", ";\n  border-radius: ", ";\n  border: ", ";\n  box-shadow: ", ";\n  color: ", ";\n  overflow: hidden;\n  position: relative;\n\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var CardBody = styled__default['default'].div(templateObject_1$O || (templateObject_1$O = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), styledSystem.space);
CardBody.defaultProps = {
    p: "24px",
};
var templateObject_1$O;

var CardHeader = styled__default['default'].div(templateObject_1$N || (templateObject_1$N = __makeTemplateObject(["\n  background: ", ";\n  ", "\n"], ["\n  background: ", ";\n  ", "\n"])), function (_a) {
...
var CardFooter = styled__default['default'].div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  border-top: 1px solid ", ";\n  ", "\n"], ["\n  border-top: 1px solid ", ";\n  ", "\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledCardRibbon = styled__default['default'].div(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  z-index: 1;\n  background-color: ", ";\n  color: white;\n  margin: 0;\n  padding: 0;\n  padding: 8px 0;\n  position: absolute;\n  right: ", ";\n  top: 0;\n  text-align: center;\n  transform: translateX(30%) translateY(0%) rotate(45deg);\n  transform: ", ";\n  transform-origin: top left;\n  width: 96px;\n\n  &:before,\n  &:after {\n    background-color: ", ";\n    content: \"\";\n    height: 100%;\n    margin: 0 -1px; /* Removes tiny gap */\n    position: absolute;\n    top: 0;\n    width: 100%;\n  }\n\n  &:before {\n    right: 100%;\n  }\n\n  &:after {\n    left: 100%;\n  }\n\n  & > div {\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    width: 96px;\n  }\n"], ["\n  z-index: 1;\n  background-color: ", ";\n  color: white;\n  margin: 0;\n  padding: 0;\n  padding: 8px 0;\n  position: absolute;\n  right: ", ";\n  top: 0;\n  text-align: center;\n  transform: translateX(30%) translateY(0%) rotate(45deg);\n  transform: ",
    ";\n  transform-origin: top left;\n  width: 96px;\n\n  &:before,\n  &:after {\n    background-color: ", ";\n    content: \"\";\n    height: 100%;\n    margin: 0 -1px; /* Removes tiny gap */\n    position: absolute;\n    top: 0;\n    width: 100%;\n  }\n\n  &:before {\n    right: 100%;\n  }\n\n  &:after {\n    left: 100%;\n  }\n\n  & > div {\n    overflow: hidden;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    width: 96px;\n  }\n"])), function (_a) {
...
var Checkbox = styled__default['default'].input.attrs({ type: "checkbox" })(templateObject_1$K || (templateObject_1$K = __makeTemplateObject(["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 8px;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 0px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"], ["\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ", ";\n  width: ", ";\n  vertical-align: middle;\n  transition: background-color 0.2s ease-in-out;\n  border: 0;\n  border-radius: 8px;\n  background-color: ", ";\n  box-shadow: ", ";\n\n  &:after {\n    content: \"\";\n    position: absolute;\n    border-bottom: 0px solid;\n    border-left: 2px solid;\n    border-color: transparent;\n    top: 30%;\n    left: 0;\n    right: 0;\n    width: 50%;\n    height: 25%;\n    margin: auto;\n    transform: rotate(-50deg);\n    transition: border-color 0.2s ease-in-out;\n  }\n\n  &:hover:not(:disabled):not(:checked) {\n    box-shadow: ", ";\n  }\n\n  &:focus {\n    outline: none;\n    box-shadow: ", ";\n  }\n\n  &:checked {\n    background-color: ", ";\n    &:after {\n      border-color: white;\n    }\n  }\n\n  &:disabled {\n    cursor: default;\n    opacity: 0.6;\n  }\n"])), getScale$3, getScale$3, function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var DropdownContent$1 = styled__default['default'].div(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 400px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"], ["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 400px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"])), getLeft, getBottom, function (_a) {
    var theme = _a.theme;
...
var bunnyFall = styled.keyframes(templateObject_1$I || (templateObject_1$I = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n    transform: translate(0, -100%) rotateZ(0deg);\n  }\n\n  75% {\n    opacity: 1;\n    transform: translate(100px, 75vh) rotateZ(270deg);\n  }\n\n  100% {\n    opacity: 0;\n    transform: translate(150px, 100vh) rotateZ(360deg);\n  }\n"], ["\n  0% {\n    opacity: 1;\n    transform: translate(0, -100%) rotateZ(0deg);\n  }\n\n  75% {\n    opacity: 1;\n    transform: translate(100px, 75vh) rotateZ(270deg);\n  }\n\n  100% {\n    opacity: 0;\n    transform: translate(150px, 100vh) rotateZ(360deg);\n  }\n"])));
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) {
        return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
...
var style = (_a$4 = {},
    ...
    _a$4);
var Heading = styled__default['default'](Text).attrs({ bold: true })(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  font-size: ", ";\n  font-weight: 100;\n  line-height: 1.1;\n  text-transform: uppercase;\n\n  ", " {\n    font-size: ", ";\n  }\n"], ["\n  font-size: ", ";\n  font-weight: 100;\n  line-height: 1.1;\n  text-transform: uppercase;\n\n  ", " {\n    font-size: ", ";\n  }\n"])), function (_a) {
    var scale = _a.scale;
...
var StyledWrapper = styled__default['default'].div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  align-self: start;\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"], ["\n  align-self: start;\n  max-height: ", "px;\n  max-width: ", "px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: \"\";\n    display: block;\n    padding-top: ", "%;\n  }\n\n  ", "\n"])), function (_a) {
...
var StyledTokenImage = styled__default['default'](Image)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"], ["\n  &:before {\n    border-radius: 50%;\n    border: 1px solid rgba(0, 0, 0, 0.25);\n    content: \"\";\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n    z-index: 7;\n  }\n"])));
var TokenImage = function (_a) {
    ...
    return React__default['default'].createElement(StyledTokenImage, __assign({ src: baseUrl + "/" + tokenAddress + "." + imageFormat }, props));
};
...
var TokenPairImage = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$3, __assign({ position: "relative", width: width, height: height }, props),
        React__default['default'].createElement(StyledPrimaryImage, __assign({ variant: variant, tokenAddress: primaryTokenAddress, width: width, height: height }, primaryImageProps)),
        React__default['default'].createElement(StyledSecondaryImage, __assign({ variant: variant, tokenAddress: secondaryTokenAddress, width: secondaryImageSize, height: secondaryImageSize }, secondaryImageProps))));
};
...
var BunnySlider = styled__default['default'].div(templateObject_3$7 || (templateObject_3$7 = __makeTemplateObject(["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"], ["\n  position: absolute;\n  left: 14px;\n  width: calc(100% - 14px);\n"])));
var StyledInput = styled__default['default'].input(templateObject_4$6 || (templateObject_4$6 = __makeTemplateObject(["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"], ["\n  cursor: ", ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    ", "\n  }\n\n  ::-moz-range-thumb {\n    ", "\n  }\n\n  ::-ms-thumb {\n    ", "\n  }\n"])), getCursorStyle, getBaseThumbStyles, getBaseThumbStyles, getBaseThumbStyles);
var BarBackground = styled__default['default'].div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  background-color: ", ";\n  height: 2px;\n  position: absolute;\n  top: 18px;\n  width: 100%;\n"], ["\n  background-color: ", ";\n  height: 2px;\n  position: absolute;\n  top: 18px;\n  width: 100%;\n"])), function (_a) {
    var theme = _a.theme, disabled = _a.disabled;
    return theme.colors[disabled ? "textDisabled" : "inputSecondary"];
});
var BarProgress = styled__default['default'].div(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"], ["\n  background-color: ", ";\n  filter: ", ";\n  height: 10px;\n  position: absolute;\n  top: 18px;\n"])), function (_a) {
    var theme = _a.theme;
...
var Container$3 = styled__default['default'].div(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var Spinner = function (_a) {
    var src = _a.src;
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement("img", { src: src, alt: "logo", width: "200px", style: { paddingRight: "5px" } })));
};
var templateObject_1$q;
...
var Wrapper$1 = styled__default['default'](Flex)(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  border-bottom: 0px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"], ["\n  border-bottom: 0px solid ", ";\n  overflow-x: scroll;\n\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none; /* IE and Edge */\n  scrollbar-width: none; /* Firefox */\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
...
var Tab = styled__default['default'].button(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"], ["\n  display: inline-flex;\n  justify-content: center;\n  cursor: pointer;\n  border: 0;\n  outline: 0;\n  flex-grow: 1;\n  padding: ", ";\n  border-radius: ", ";\n  font-size: 16px;\n  font-weight: 600;\n\n  ", " {\n    flex-grow: 0;\n  }\n\n  ", "\n"])), getPadding, getBorderRadius, function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
}, styledSystem.color);
Tab.defaultProps = {
...
function BrandLogo(props) {
    return (React__namespace.createElement("svg", __assign({ id: "prefix__Layer_2", "data-name": "Layer 2", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 319.843 62.999" }, props),
        React__namespace.createElement("defs", null,
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient", x1: 21.432, y1: 24.815, x2: 21.432, y2: 37.339, gradientUnits: "userSpaceOnUse" },
                React__namespace.createElement("stop", { offset: 0, stopColor: "#fff" }),
                React__namespace.createElement("stop", { offset: 0.298, stopColor: "#fffdff" }),
                React__namespace.createElement("stop", { offset: 0.443, stopColor: "#fdf5fe" }),
                React__namespace.createElement("stop", { offset: 0.555, stopColor: "#fae8fc" }),
                React__namespace.createElement("stop", { offset: 0.65, stopColor: "#f6d6fa" }),
                React__namespace.createElement("stop", { offset: 0.665, stopColor: "#f5d2fa" }),
                React__namespace.createElement("stop", { offset: 0.74, stopColor: "#f1d2fa" }),
                React__namespace.createElement("stop", { offset: 0.822, stopColor: "#e3d2f9" }),
                React__namespace.createElement("stop", { offset: 0.907, stopColor: "#ced3f7" }),
                React__namespace.createElement("stop", { offset: 0.994, stopColor: "#afd4f5" }),
                React__namespace.createElement("stop", { offset: 1, stopColor: "#add4f5" })),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-2", x1: 40.337, y1: 24.815, x2: 40.337, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-3", x1: 45.371, y1: 21.178, x2: 45.371, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-4", x1: 58.3, y1: 21.178, x2: 58.3, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-5", x1: 90.611, y1: 24.815, x2: 90.611, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-6", x1: 109.021, y1: 24.815, x2: 109.021, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-7", x1: 114.141, y1: 21.178, x2: 114.141, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-8", x1: 146.946, y1: 24.815, x2: 146.946, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-9", x1: 151.448, y1: 21.178, x2: 151.448, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-10", x1: 167.342, y1: 21.178, x2: 167.342, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-11", x1: 186.105, y1: 21.178, x2: 186.105, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-12", x1: 197.087, y1: 21.178, x2: 197.087, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-13", x1: 209.113, y1: 21.178, x2: 209.113, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-14", x1: 219.801, y1: 21.178, x2: 219.801, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-15", x1: 233.632, y1: 21.178, x2: 233.632, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-16", x1: 254.59, y1: 21.178, x2: 254.59, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-17", x1: 275.565, y1: 21.178, x2: 275.565, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-18", x1: 308.977, y1: 24.815, x2: 308.977, y2: 37.339, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("linearGradient", { id: "prefix__linear-gradient-19", x1: 312.796, y1: 21.178, x2: 312.796, y2: 33.703, xlinkHref: "#prefix__linear-gradient" }),
            React__namespace.createElement("style", null, ".prefix__cls-2{fill:#b2d5f1}.prefix__cls-3{fill:#fff}.prefix__cls-4{fill:#c4e9f7}.prefix__cls-5{fill:#abb1d9}.prefix__cls-14{fill:#da9ded}")),
        React__namespace.createElement("g", { opacity: 0.2 },
            React__namespace.createElement("path", { className: "prefix__cls-2", d: "M143.553 34.556l-10.041-2.271-4.279 12.575 7.422-8.383 6.898-1.921z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M142.904 48.995a.5.5 0 01-.473-.66l4.279-12.574a.5.5 0 01.584-.327l10.04 2.27a.5.5 0 01.024.97l-6.756 1.882-7.324 8.27a.5.5 0 01-.374.17zm4.608-12.486l-3.333 9.793 5.773-6.52a.496.496 0 01.24-.15l4.988-1.389z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-2", d: "M141.196 41.018l2.357-6.462-6.898 1.921 4.541 4.541z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M154.867 45.155a.5.5 0 01-.354-.147l-4.54-4.54a.5.5 0 01.219-.836l6.898-1.92a.5.5 0 01.604.652l-2.358 6.462a.5.5 0 01-.47.329zm-3.582-4.79l3.38 3.381 1.756-4.81z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-4", d: "M141.196 41.018l-4.541-4.541-7.422 8.383 16.766 8.819-4.803-12.661z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M159.67 57.816a.495.495 0 01-.233-.058l-16.766-8.82a.5.5 0 01-.142-.773l7.423-8.382a.5.5 0 01.728-.023l4.54 4.541a.496.496 0 01.114.176l4.803 12.661a.5.5 0 01-.467.678zM143.7 48.35l15.034 7.908-4.297-11.326-4.089-4.089z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls
", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { fill: "#a296c9", d: "M169.139 41.891l-6.462 20.607 11.876-22.266-5.414 1.659z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.5.5 0 01-.478-.65l6.461-20.606a.505.505 0 01.331-.329l5.414-1.659a.5.5 0 01.588.714L176.79 66.37a.501.501 0 01-.441.264zm6.859-20.705l-4.78 15.243 8.785-16.47z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { fill: "#c89fc9", d: "M152.198 30.539l-11.002 10.479 15.281 2.707-4.279-13.186z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M170.148 47.86a.543.543 0 01-.087-.007l-15.282-2.706a.5.5 0 01-.257-.855l11.003-10.479a.5.5 0 01.82.208l4.279 13.185a.5.5 0 01-.476.655zm-14.22-3.526l13.488 2.389-3.777-11.638z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { fill: "#edd3e6", d: "M156.477 43.725l6.2 18.773-2.009-18.075-4.191-.698z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.5.5 0 01-.475-.343l-6.2-18.773a.5.5 0 01.095-.482.49.49 0 01.462-.168l4.19.698a.501.501 0 01.416.437l2.009 18.075a.5.5 0 01-.39.544.495.495 0 01-.107.012zm-5.466-18.644l4.44 13.445-1.439-12.945z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { fill: "#c49fca", d: "M169.139 41.891l-8.296 2.532h-.175l2.009 18.075 6.462-20.607z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634c-.016 0-.033 0-.048-.002a.502.502 0 01-.45-.442l-2.009-18.075a.5.5 0 01.497-.556h.1l8.226-2.51a.5.5 0 01.623.628l-6.461 20.606a.501.501 0 01-.478.351zm-1.461-18.167l1.695 15.25 5.466-17.434z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { fill: "#d8eff5", d: "M170.448 31.5l4.105 8.732 5.413-10.217-9.518 1.485z" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M188.224 44.368h-.012a.5.5 0 01-.44-.287l-4.105-8.732a.5.5 0 01.375-.707l9.518-1.485a.5.5 0 01.518.729l-5.413 10.217a.5.5 0 01-.441.265zm-3.368-8.84l3.394 7.222 4.477-8.45z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.499.499 0 01-.354-.146l-21.482-21.48a.5.5 0 01-.117-.521L168.803 3.97a.501.501 0 01.446-.332.492.492 0 01.477.284l18.949 39.732a.5.5 0 01-.01.45L176.79 66.37a.498.498 0 01-.368.259.453.453 0 01-.073.005zm-20.905-22.11l20.78 20.78 11.44-21.448L169.342 5.44z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.347 66.635a.5.5 0 01-.496-.443l-7.073-61.998a.5.5 0 01.993-.114l7.074 61.998a.5.5 0 01-.44.554.599.599 0 01-.058.003z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M174.515 48.56a.434.434 0 01-.086-.008l-19.648-3.406a.5.5 0 11.171-.984l19.648 3.406a.5.5 0 01-.085.992z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M174.514 48.56a.5.5 0 01-.146-.979l13.71-4.191a.5.5 0 01.292.957l-13.71 4.191a.502.502 0 01-.146.022zM154.867 45.154a.5.5 0 01-.345-.863l11.002-10.478a.5.5 0 01.69.725L155.21 45.016a.5.5 0 01-.344.138z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.5.5 0 01-.475-.344l-13.972-42.525a.5.5 0 01.95-.313l13.971 42.526a.5.5 0 01-.318.63.484.484 0 01-.156.026z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.493.493 0 01-.15-.022.501.501 0 01-.328-.627l6.413-20.454L168.8 4.292a.5.5 0 11.95-.31l13.536 41.39a.507.507 0 01.002.305l-6.461 20.606a.501.501 0 01-.477.351z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.349 66.634a.5.5 0 01-.353-.854L202.5 39.362l-7.258-10.03-10.874 6.238a.5.5 0 11-.498-.867l11.265-6.462a.5.5 0 01.654.14l7.772 10.74a.5.5 0 01-.053.648L176.7 66.489a.497.497 0 01-.352.145z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M203.155 39.914a.499.499 0 01-.258-.072l-9.364-5.668-9.337 1.456a.5.5 0 01-.154-.988l9.518-1.485a.504.504 0 01.335.067l9.52 5.762a.5.5 0 01-.26.928z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.5.5 0 01-.442-.735l17.29-32.483a.5.5 0 11.882.47L176.79 66.37a.499.499 0 01-.441.265z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M188.223 44.368a.5.5 0 01-.07-.995l12.225-1.747a.51.51 0 01.565.425.5.5 0 01-.424.565l-12.225 1.748a.587.587 0 01-.071.005zM176.349 66.634a.5.5 0 01-.234-.057l-33.445-17.64a.5.5 0 01-.24-.603l4.28-12.573a.5.5 0 01.584-.327l10.04 2.27a.5.5 0 11-.22.976l-9.602-2.171-3.997 11.743 33.067 17.44a.5.5 0 01-.233.942z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M142.904 48.995a.5.5 0 01-.375-.83l7.423-8.383a.496.496 0 01.24-.15l6.898-1.92a.5.5 0 11.268.962l-6.756 1.882-7.324 8.27a.497.497 0 01-.374.17z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M176.348 66.635a.498.498 0 01-.354-.146l-26.021-26.022a.5.5 0 01.707-.707L176.7 65.782a.5.5 0 01-.353.853z", transform: "translate(-13.671 -3.636)" }),
            React__namespace.createElement("path", { className: "prefix__cls-3", d: "M159.67 57.816a.5.5 0 01-.468-.323L154.4 44.831a.5.5 0 11.935-.355l4.803 12.662a.5.5 0 01-.29.645.511.511 0 01-.178.033z", transform: "translate(-13.671 -3.636)" })),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M23.115 51.602v-6.948h-2.568v-.78h6.12v.78h-2.568v6.948zM28.047 51.602v-8.088h.984v3.012a3.326 3.326 0 01.93-.528 3.453 3.453 0 011.242-.204 1.816 1.816 0 012.064 2.088v3.72h-.984v-3.684a1.346 1.346 0 00-.33-1.038 1.617 1.617 0 00-1.085-.294 2.58 2.58 0 00-.99.21 2.551 2.551 0 00-.846.546v4.26zM37.671 51.722a3.16 3.16 0 01-2.28-.732 3.01 3.01 0 01-.755-2.256 3.268 3.268 0 01.653-2.155 2.545 2.545 0 012.07-.785 2.81 2.81 0 011.386.306 1.968 1.968 0 01.816.84 2.633 2.633 0 01.27 1.206v1.068h-4.212a2.217 2.217 0 00.282 1.02 1.296 1.296 0 00.708.535 3.962 3.962 0 001.254.162 4.198 4.198 0 001.608-.3v.767a3.969 3.969 0 01-.834.24 5.42 5.42 0 01-.966.084zm-2.052-3.216h3.336v-.469a1.48 1.48 0 00-.366-1.073 1.627 1.627 0 00-1.206-.378 1.68 1.68 0 00-1.392.48 2.33 2.33 0 00-.372 1.44zM44.39 51.602v-7.728h3.025a3.069 3.069 0 012.46.911 4.608 4.608 0 01.78 3 4.502 4.502 0 01-.763 2.899 3.045 3.045 0 01-2.478.918zm.985-.768h1.86a3.272 3.272 0 001.356-.246 1.604 1.604 0 00.81-.906 5.216 5.216 0 00.27-1.897 5.845 5.845 0 00-.246-1.907 1.623 1.623 0 00-.78-.954 3.132 3.132 0 00
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M41.647 19.973h-3.134v13.375h13.716v-2.432H41.647V19.973zM58.329 25.806l-6.136-5.833h-3.952l8.549 8.075v5.3h3.097v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M82.946 26.84v6.914c0 1.92 1.177 3.23 4.293 3.23h11.038v-2.432H87.239c-.779 0-1.197-.228-1.197-.778V26.8c0-.531.418-.778 1.197-.778h11.038V23.61H87.239c-3.116 0-4.293 1.311-4.293 3.23zM112.678 23.61h-11.626v13.374h3.097v-5.947h6.383l2.982 5.947h3.325L113.837 31c2.394-.323 3.153-1.597 3.153-3.192v-.97c0-1.917-1.196-3.228-4.312-3.228zm1.197 4.218c0 .645-.38.798-1.197.798h-8.53v-2.603h8.53c.78 0 1.197.247 1.197.778z", transform: "translate(-13.671 -3.636)" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M114.169 25.806l-6.136-5.833h-3.951l8.549 8.075v5.3h3.096v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M150.945 28.606h-7.998c-.874 0-1.235-.246-1.235-.817v-.95c0-.607.418-.816 1.235-.816h11.569V23.61h-11.57c-3.134 0-4.33 1.312-4.33 3.25v.91c0 1.938 1.196 3.249 4.33 3.249h7.999c.854 0 1.215.209 1.215.816v1.92c0 .646-.341.797-1.215.797h-11.893v2.432h11.893c3.134 0 4.33-1.33 4.33-3.268v-1.861c0-1.938-1.196-3.25-4.33-3.25z", transform: "translate(-13.671 -3.636)" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M159.826 19.973H143.07v2.414h6.897v10.961h3.115V22.387h6.744v-2.414zM166.23 19.973l-8.91 13.375h3.457l6.612-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28zM182.381 19.973h-3.134v13.375h13.715v-2.432h-10.581V19.973zM195.263 30.878h3.647v2.47h-3.647zM202.065 33.348h3.097v-5.3h10.22v-2.413h-10.22v-3.248h10.999v-2.414h-14.096v13.375zM218.252 19.974h3.097v13.374h-3.097zM239.987 29.131l-12.747-9.158h-2.679v13.375h2.697v-9.746l13.926 9.746h1.52V19.973h-2.717v9.158zM253.478 19.973l-8.909 13.375h3.457l6.611-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28zM281.919 29.131l-12.747-9.158h-2.678v13.375h2.697v-9.746l13.926 9.746h1.519V19.973h-2.717v9.158z" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M301.312 26.84v6.914c0 1.92 1.178 3.23 4.293 3.23h11.037v-2.432h-11.037c-.778 0-1.196-.228-1.196-.778V26.8c0-.531.418-.778 1.196-.778h11.037V23.61h-11.037c-3.115 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)" }),
        React__namespace.createElement("path", { className: "prefix__cls-3", d: "M305.748 33.348h14.095v-2.432h-10.999v-3.419h10.41v-2.432h-10.41v-2.678h10.999v-2.414h-14.095v13.375z" }),
        React__namespace.createElement("path", { d: "M24.899 23.61H13.67v13.374h3.097V32.14h8.13c3.116 0 4.294-1.312 4.294-3.23v-2.07c0-1.919-1.178-3.23-4.293-3.23zm1.197 5.32c0 .494-.286.779-.893.779h-8.435v-3.686h8.415a.82.82 0 01.913.874z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient)" }),
        React__namespace.createElement("path", { d: "M44.867 23.61h-9.061c-3.116 0-4.293 1.312-4.293 3.23v6.915c0 1.919 1.177 3.23 4.293 3.23h9.062c3.115 0 4.293-1.311 4.293-3.23v-6.916c0-1.918-1.178-3.229-4.294-3.229zm1.197 10.164c0 .55-.418.778-1.196.778h-9.063c-.778 0-1.196-.227-1.196-.778v-6.973c0-.531.418-.778 1.197-.778h9.062c.778 0 1.196.247 1.196.778z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-2)" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-3)", d: "M41.648 19.973h-3.135v13.375h13.716v-2.432H41.648V19.973z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-4)", d: "M58.329 25.806l-6.136-5.833h-3.952l8.549 8.075v5.3h3.097v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React__namespace.createElement("path", { d: "M82.946 26.84v6.914c0 1.92 1.177 3.23 4.293 3.23h11.038v-2.432H87.239c-.779 0-1.197-.228-1.197-.778V26.8c0-.531.418-.778 1.197-.778h11.038V23.61H87.239c-3.116 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-5)" }),
        React__namespace.createElement("path", { d: "M112.678 23.61h-11.626v13.374h3.097v-5.947h6.383l2.982 5.947h3.325L113.837 31c2.394-.323 3.154-1.597 3.154-3.192v-.97c0-1.917-1.197-3.228-4.313-3.228zm1.197 4.218c0 .645-.38.798-1.197.798h-8.53v-2.603h8.53c.78 0 1.197.247 1.197.778z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-6)" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-7)", d: "M114.169 25.806l-6.136-5.833h-3.951l8.549 8.075v5.3h3.096v-5.3l8.472-8.075h-3.913l-6.117 5.833z" }),
        React__namespace.createElement("path", { d: "M150.945 28.606h-7.998c-.874 0-1.235-.246-1.235-.817v-.95c0-.607.418-.816 1.235-.816h11.569V23.61h-11.57c-3.134 0-4.33 1.312-4.33 3.25v.91c0 1.938 1.196 3.249 4.33 3.249h7.999c.854 0 1.215.209 1.215.816v1.92c0 .646-.341.797-1.215.797h-11.893v2.432h11.893c3.134 0 4.33-1.33 4.33-3.268v-1.861c0-1.938-1.195-3.25-4.33-3.25z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-8)" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-9)", d: "M159.826 19.973H143.07v2.414h6.897v10.961h3.115V22.387h6.744v-2.414z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-10)", d: "M166.23 19.973l-8.91 13.375h3.457l6.612-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-11)", d: "M182.381 19.973h-3.134v13.375h13.715v-2.432h-10.581V19.973z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-12)", d: "M195.263 30.878h3.647v2.47h-3.647z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-13)", d: "M202.065 33.348h3.097v-5.3h10.22v-2.413h-10.22v-3.248h10.999v-2.414h-14.096v13.375z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-14)", d: "M218.252 19.974h3.097v13.374h-3.097z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-15)", d: "M239.987 29.131l-12.747-9.158h-2.679v13.375h2.697v-9.746l13.926 9.746h1.52V19.973h-2.717v9.158z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-16)", d: "M253.478 19.973l-8.909 13.375h3.457l6.611-10.183 6.478 10.183h3.496l-8.853-13.375h-2.28z" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-17)", d: "M281.92 29.131l-12.748-9.158h-2.678v13.375h2.697v-9.746l13.926 9.746h1.519V19.973h-2.716v9.158z" }),
        React__namespace.createElement("path", { d: "M301.312 26.84v6.914c0 1.92 1.178 3.23 4.293 3.23h11.037v-2.432h-11.037c-.778 0-1.196-.228-1.196-.778V26.8c0-.531.418-.778 1.196-.778h11.037V23.61h-11.037c-3.115 0-4.293 1.311-4.293 3.23z", transform: "translate(-13.671 -3.636)", fill: "url(#prefix__linear-gradient-18)" }),
        React__namespace.createElement("path", { fill: "url(#prefix__linear-gradient-19)", d: "M305.748 33.348h14.095v-2.432h-10.999v-3.419h10.41v-2.432h-10.41v-2.678h10.999v-2.414h-14.095v13.375z" })));
}

// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
function IconLogo(props) {
    return (React__namespace.createElement("svg", __assign({ id: "prefix__Layer_1", "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 251.491 259.275" }, props),
...
var ModalHeader = styled__default['default'].div(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"], ["\n  align-items: center;\n  background: ", ";\n  border-bottom: 1px solid ", ";\n  display: flex;\n  padding: 12px 24px;\n"])), function (_a) {
...
var Icon$k = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 330 330" }, props),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M165,0C74.019,0,0,74.02,0,165.001C0,255.982,74.019,330,165,330s165-74.018,165-164.999C330,74.02,255.981,0,165,0z\n\t\t M165,300c-74.44,0-135-60.56-135-134.999C30,90.562,90.56,30,165,30s135,60.562,135,135.001C300,239.44,239.439,300,165,300z" }),
            React__default['default'].createElement("path", { d: "M164.998,70c-11.026,0-19.996,8.976-19.996,20.009c0,11.023,8.97,19.991,19.996,19.991\n\t\tc11.026,0,19.996-8.968,19.996-19.991C184.994,78.976,176.024,70,164.998,70z" }),
            React__default['default'].createElement("path", { d: "M165,140c-8.284,0-15,6.716-15,15v90c0,8.284,6.716,15,15,15c8.284,0,15-6.716,15-15v-90C180,146.716,173.284,140,165,140z\n\t\t" }))));
};
...
var Icon$9 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 335 400" }, props),
        React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m152.5 104c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m264.5 72c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m376.5 168c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" }),
        React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "m40.5 0c-4.417969 0-8 3.582031-8 8v40h-24c-4.417969 0-8 3.582031-8 8v208c0 4.417969 3.582031 8 8 8h24v32c0 4.417969 3.582031 8 8 8s8-3.582031 8-8v-32h24c4.417969 0 8-3.582031 8-8v-208c0-4.417969-3.582031-8-8-8h-24v-40c0-4.417969-3.582031-8-8-8zm24 64v192h-48v-192zm0 0" })));
};
...
React__default['default'].memo(ThemeSwitcher, function (prev, next) { return prev.isDark === next.isDark; });
...
var TokenPrice = function (_a) {
    ...
    return tokenPriceUsd ? (React__default['default'].createElement(PriceLink, { href: infoLink, target: "_blank" },
        showIcon && React__default['default'].createElement(IconLogo, { width: "30px", style: { paddingRight: "5px" } }),
        React__default['default'].createElement(Text, { color: "contrast", bold: true }, "$" + tokenPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var TokenPrice$1 = React__default['default'].memo(TokenPrice);
...
var Logo = function (_a) {
    ...
    var innerLogo = React__default['default'].createElement(React__default['default'].Fragment, null, isDark ? React__default['default'].createElement(IconLogo, { className: "logo" }) : React__default['default'].createElement(IconLogo, { className: "logo" }));
    var brand = React__default['default'].createElement("h1", { className: "brand-name" }, "??");
    return (React__default['default'].createElement(Flex, null,
        isMobile && (React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$n, { width: "24px", color: "primary" })) : (React__default['default'].createElement(Icon$o, { width: "24px", color: "primary" })))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { className: "brand", as: "a", href: href, "aria-label": "PolyCrystal Finance" },
            innerLogo,
            isMobile ? React__default['default'].createElement(React__default['default'].Fragment, null) : brand)) : (React__default['default'].createElement(StyledLink, { className: "brand", to: href, "aria-label": "?" },
                innerLogo,
                isMobile ? React__default['default'].createElement(React__default['default'].Fragment, null) : brand)),
        isMobile && React__default['default'].createElement(TokenPrice$1, { tokenPriceUsd: tokenPriceUsd, showIcon: false, infoLink: infoLink })));
};
...
var DropdownContent = styled__default['default'].div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  display: none;\n  position: absolute;\n  color: ", ";\n  background-color: ", ";\n  border-color: ", ";\n  z-index: 1;\n  overflow: hidden;\n"], ["\n  display: none;\n  position: absolute;\n  color: ", ";\n  background-color: ", ";\n  border-color: ", ";\n  z-index: 1;\n  overflow: hidden;\n"])), function (_a) {
    var theme = _a.theme;
...
var Dropdown = styled__default['default'].div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: relative;\n  display: inline-block;\n  &:hover ", " {\n    display: block;\n    transition: max-height 0.3s ease-out;\n  }\n"], ["\n  position: relative;\n  display: inline-block;\n  &:hover ", " {\n    display: block;\n    transition: max-height 0.3s ease-out;\n  }\n"])), DropdownContent);
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null, isMobile ? (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(AccordionContent, { isOpen: isOpen, isPushed: isPushed, maxHeight: React__default['default'].Children.count(children) * MENU_ENTRY_HEIGHT }, children))) : (React__default['default'].createElement(Dropdown, null,
            React__default['default'].createElement(MenuEntry, { onMouseEnter: handleClick, onMouseLeave: handleClick, className: className, isActive: isActive, role: "button" },
                label !== "More" && icon,
                React__default['default'].createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, label),
                status && (React__default['default'].createElement(LinkStatus, { color: status.color, fontSize: "14px" }, status.text)),
                React__default['default'].createElement(Icon$1x, null)),
            React__default['default'].createElement(DropdownContent, null, children)))));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
        ...
        return (React__default['default'].createElement(MenuLink, { key: entry.label, href: entry.href, onClick: handleClick },
            React__default['default'].createElement(MenuEntry, { isActive: entry.href === location.pathname, className: calloutClass },
                iconElement,
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown$1, {
...
React__default['default'].memo(LangSelector, function (prev, next) { return prev.currentLang === next.currentLang; });
...
var SocialLinks = function () {
    return (React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
        ...
        if (social.items) {
            return (React__default['default'].createElement(Dropdown$1, { key: social.label, position: "top", target: React__default['default'].createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React__default['default'].createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "textSubtle" }, item.label)); })));
        }
        return (React__default['default'].createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
            React__default['default'].createElement(Icon, __assign({}, iconProps))));
    })));
};
React__default['default'].memo(SocialLinks, function () { return true; });
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null,
            React__default['default'].createElement(TokenPrice$1, { tokenPriceUsd: crystlPriceUsd, showIcon: true, infoLink: infoLink })),
        false,
        false,
        false));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://polycrystalfinance.medium.com/crystal-clear-educational-series-2-setting-up-a-metamask-wallet-a762f5668941", external: true },
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({
        ...
        children,
        React__default['default'].createElement(Icon$1b, { width: "20px", color: "primary", ml: "10px" }),
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bscscan/address/" + account, mr: "16px" }, "View on BSCScan"),
...
var StyledButton = styled__default['default'](Button)(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  min-width: 125px;\n"], ["\n  min-width: 125px;\n"])));
var UserBlock = function (_a) {
    var account = _a.account, login = _a.login, logout = _a.logout;
    var _b = useWalletModal(login, logout, account), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
    var accountEllipsis = account ? account.substring(0, 4) + "..." + account.substring(account.length - 4) : null;
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(StyledButton, {
        scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        }
    }, accountEllipsis)) : (React__default['default'].createElement(StyledButton, {
...
var Menu = function (_a) {
    ...
    var _c = React.useState(!isMobile ? false : !isMobile), isPushed = _c[0], setIsPushed = _c[1];
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo, { isPushed: isMobile ? isPushed : false, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/", isMobile: isMobile, tokenPriceUsd: crystlPriceUsd, infoLink: infoLink }),
            !isMobile &&
            links.map(function (entry) {
                ...
                if (entry.items) {
                    var itemsMatchIndex = entry.items.findIndex(function (item) { return item.href === location.pathname; });
                    var initialOpenState = entry.initialOpenState === true ? entry.initialOpenState : itemsMatchIndex >= 0;
                    return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isMobile, pushNav: setIsPushed, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                        entry.items.map(function (item) {
                            return (React__default['default'].createElement(MenuLink, { href: item.href },
                                React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                                    React__default['default'].createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, item.label))));
                        })));
                }
                return (React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: entry.calloutClass ? entry.calloutClass : undefined },
                        iconElement,
                        React__default['default'].createElement(LinkLabelMemo, { isPushed: isMobile ? isPushed : true }, entry.label))));
            }),
            !isMobile && React__default['default'].createElement(TokenPrice$1, { tokenPriceUsd: crystlPriceUsd, showIcon: true, infoLink: infoLink }),
        ...
        React__default['default'].createElement(BodyWrapper, null,
            isMobile && (React__default['default'].createElement(Panel, { isPushed: isMobile ? isPushed : true, isMobile: isMobile, showMenu: isMobile ? showMenu : false, toggleTheme: toggleTheme, isDark: isDark, langs: langs, setLang: setLang, currentLang: currentLang, crystlPriceUsd: crystlPriceUsd, pushNav: setIsPushed, links: links, infoLink: infoLink })),
