    ...
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">
              {TranslateString(999, "Coming Soon to PancakeSwap.")}
            </Title>
            <Text mb={3}>
              {TranslateString(
                504,
                "You’ll pay for the new tokens using SHIFT-BNB LP tokens, which means you need to stake equal amounts of SHIFT and BNB in a liquidity pool to take part."
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://exchange.pancakeswap.finance/#/add/BNB/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
                {TranslateString(506, "Get SHIFT-BNB LP >")}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(
                508,
                "The project gets the BNB, PancakeSwap burns the SHIFT."
              )}
              <br />
