    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy SHIFT and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get SHIFT-BNB LP tokens by adding SHIFT and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://exchange.pancakeswap.finance/#/swap" mr="16px">
              {TranslateString(1060, 'Buy SHIFT')}
            </LinkExternal>
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your SHIFT-LP tokens to buy the IFO tokens')}</li>
          </List>
