...
const Nfts: Nft[] = [
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master SHIFT chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's SHIFT)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
