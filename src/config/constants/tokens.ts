import { appConfig, defaultToken } from 'app.config'

const defaultTokenName = appConfig.ticker.toLowerCase()
const clonedDefaultToken = JSON.parse(JSON.stringify(defaultToken))
...
const tokens = {
  ...
  [defaultTokenName]: clonedDefaultToken,
  question: {
    symbol: 'SHIFT',
    address: {
