...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#F6F6F6", backgroundDisabled: "#E9EAEB", backgroundAlt: "#353547", cardBorder: "#AFD5F5", contrast: "#D99CFA", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#F5D3FA", input: "#C2EDFC", inputSecondary: "#AFD5F5", tertiary: "#EFF4F5", text: "#FFFFFF", textDisabled: "#BDC2C4", textSubtle: "#00008B", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#F5D3FA", background: "#202231", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#0098A1;", text: "#BEBEBE;", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown$1, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(StyledButton, { scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(StyledButton, { scale: "sm", onClick: function () {
                ...
                links.map(function (entry) {
                    ...
                    if (entry.items) {
                        ...
                        return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isMobile, pushNav: setIsPushed, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                            entry.items.map(function (item) { return (React__default['default'].createElement(MenuLink, { href: item.href },
