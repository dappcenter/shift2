...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#000000", backgroundDisabled: "#E9EAEB", backgroundAlt: "#000000", cardBorder: "#b1a9c4", contrast: "#D99CFA", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#F5D3FA", input: "#C2EDFC", inputSecondary: "#b1a9c4", tertiary: "#EFF4F5", text: "#cdc9d4", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", disabled: "#E9EAEB", gradients: {
        background: "#000000",
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#b1a9c4", background: "#000000", backgroundDisabled: "#3c3742", backgroundAlt: "#000000", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#666171", inputSecondary: "#b1a9c4", primaryDark: "#0098A1", tertiary: "#353547", text: "#b5bdbd", textDisabled: "#666171", textSubtle: "#FFFFFF", disabled: "#524B63", gradients: {
    background: "#000000",
...
var Logo = function (_a) {
    ...
    var brand = React__default.createElement("h1", { className: "brand-name" }, "Shift");
    ...
    return (React__default.createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            ...
            return (React__default.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                entry.items.map(function (item) { return (React__default.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
...
var LangSelector = function (_a) {
    ...
    return (React__default.createElement(Dropdown$1, { position: "top-right", target: React__default.createElement(Button, { variant: "text", startIcon: React__default.createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
            React__default.createElement(Text, { color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React__default.createElement(MenuButton, { key: lang.locale, fullWidth: true, onClick: function () { return setLang(lang); }, 
        // Safari fix
...
var SocialLinks = function () { return (React__default.createElement(Flex, null, socials.map(function (social, index) {
...
var WalletCard = function (_a) {
    ...
    return (React__default.createElement(Button, { width: "100%", variant: "tertiary", onClick: function () {
...
var AccountModal = function (_a) {
    ...
    return (React__default.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React__default.createElement(Text, { fontSize: "20px", bold: true, style: {
                whiteSpace: "nowrap",
                overflow: "hidden",
        ...
        React__default.createElement(Flex, { mb: "32px" },
            React__default.createElement(LinkExternal, { small: true, href: "https://polygonscan.com/address/" + account, mr: "16px" }, "View on Polygonscan"),
...
var UserBlock = function (_a) {
    ...
    return (React__default.createElement("div", null, account ? (React__default.createElement(StyledButton, { scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default.createElement(StyledButton, { scale: "sm", onClick: function () {
                ...
                links.map(function (entry) {
                    ...
                    if (entry.items) {
                        ...
                        return (React__default.createElement(Accordion, { key: entry.label, isPushed: isMobile, pushNav: setIsPushed, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }), isMobile: isMobile }, isPushed &&
                            entry.items.map(function (item) { return (React__default.createElement(MenuLink, { href: item.href },
